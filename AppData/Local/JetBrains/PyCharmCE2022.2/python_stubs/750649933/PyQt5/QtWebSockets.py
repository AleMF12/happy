...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtWebSockets.pyd
# by generator 1.147
# no doc
...
class QWebSocket(__PyQt5_QtCore.QObject):
    ...
    def setMaxAllowedIncomingFrameSize(self, p_int): # real signature unknown; restored from __doc__
        """ setMaxAllowedIncomingFrameSize(self, int) """
        pass

    def setMaxAllowedIncomingMessageSize(self, p_int): # real signature unknown; restored from __doc__
        """ setMaxAllowedIncomingMessageSize(self, int) """
        pass

    def setOutgoingFrameSize(self, p_int): # real signature unknown; restored from __doc__
        """ setOutgoingFrameSize(self, int) """
        pass
...
class QWebSocketServer(__PyQt5_QtCore.QObject):
    ...
    def setHandshakeTimeout(self, p_int): # real signature unknown; restored from __doc__
        """ setHandshakeTimeout(self, int) """
        pass
    ...
    def setNativeDescriptor(self, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ setNativeDescriptor(self, PyQt5.sip.voidptr) -> bool """
        return False
