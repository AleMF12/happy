...
class QTextCodec(__sip.wrapper):
    ...
    def convertFromUnicode(self, PyQt5_sip_array, p_str=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ convertFromUnicode(self, PyQt5.sip.array[str], QTextCodec.ConverterState) -> QByteArray """
        pass

    def convertToUnicode(self, PyQt5_sip_array, bytes=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ convertToUnicode(self, PyQt5.sip.array[bytes], QTextCodec.ConverterState) -> str """
        pass
    ...
    def toUnicode(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        toUnicode(self, PyQt5.sip.array[bytes], state: QTextCodec.ConverterState = None) -> str
        """
        return ""
