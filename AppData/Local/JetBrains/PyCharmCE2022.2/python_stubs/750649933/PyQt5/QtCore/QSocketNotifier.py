...
class QSocketNotifier(QObject):
    """ QSocketNotifier(PyQt5.sip.voidptr, QSocketNotifier.Type, parent: QObject = None) """
    ...
    def __init__(self, PyQt5_sip_voidptr, QSocketNotifier_Type, parent=None): # real signature unknown; restored from __doc__
        pass
