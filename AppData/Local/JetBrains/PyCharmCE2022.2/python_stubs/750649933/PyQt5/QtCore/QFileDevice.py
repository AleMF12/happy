...
class QFileDevice(QIODevice):
    ...
    def map(self, p_int, p_int_1, flags=None): # real signature unknown; restored from __doc__
        """ map(self, int, int, flags: QFileDevice.MemoryMapFlags = QFileDevice.NoOptions) -> PyQt5.sip.voidptr """
        pass
    ...
    def unmap(self, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ unmap(self, PyQt5.sip.voidptr) -> bool """
        return False
