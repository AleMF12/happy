...
class QDataStream(__sip.simplewrapper):
    ...
    def writeBytes(self, PyQt5_sip_array, bytes=None): # real signature unknown; restored from __doc__
        """ writeBytes(self, PyQt5.sip.array[bytes]) -> QDataStream """
        return QDataStream
    ...
    def writeRawData(self, PyQt5_sip_array, bytes=None): # real signature unknown; restored from __doc__
        """ writeRawData(self, PyQt5.sip.array[bytes]) -> int """
        return 0

    def writeString(self, bytes): # real signature unknown; restored from __doc__
        """ writeString(self, bytes) """
        pass
