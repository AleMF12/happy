...
class QJsonValue(__sip.simplewrapper):
    ...
    QJsonValue(Union[QJsonValue, QJsonValue.Type, Dict[str, QJsonValue], bool, int, float, None, str])
    """
    ...
    def toArray(self, Iterable=None, *args=None, **kwargs=None): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        toArray(self, Iterable[Union[QJsonValue, QJsonValue.Type, Dict[str, QJsonValue], bool, int, float, None, str]]) -> List[QJsonValue]
        """
        return []
