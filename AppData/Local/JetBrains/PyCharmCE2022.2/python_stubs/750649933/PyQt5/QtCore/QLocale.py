...
class QLocale(__sip.simplewrapper):
    ...
    def toDate(self, p_str, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        toDate(self, str, QLocale.FormatType, QCalendar) -> QDate
        toDate(self, str, str, QCalendar) -> QDate
        """
        return QDate
    ...
    def toDateTime(self, p_str, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        toDateTime(self, str, QLocale.FormatType, QCalendar) -> QDateTime
        toDateTime(self, str, str, QCalendar) -> QDateTime
        """
        return QDateTime
    ...
    def toLong(self, p_str): # real signature unknown; restored from __doc__
    ...
    def toString(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        toString(self, Union[QDateTime, datetime.datetime], str, QCalendar) -> str
        toString(self, Union[QDateTime, datetime.datetime], format: QLocale.FormatType = QLocale.LongFormat) -> str
        toString(self, Union[QDateTime, datetime.datetime], QLocale.FormatType, QCalendar) -> str
        toString(self, Union[QDate, datetime.date], str) -> str
        toString(self, Union[QDate, datetime.date], str, QCalendar) -> str
        toString(self, Union[QDate, datetime.date], format: QLocale.FormatType = QLocale.LongFormat) -> str
        toString(self, Union[QDate, datetime.date], QLocale.FormatType, QCalendar) -> str
    ...
    def toTime(self, p_str, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        toTime(self, str, QLocale.FormatType, QCalendar) -> QTime
        toTime(self, str, str, QCalendar) -> QTime
        """
        return QTime
    ...
    def toULong(self, p_str): # real signature unknown; restored from __doc__
