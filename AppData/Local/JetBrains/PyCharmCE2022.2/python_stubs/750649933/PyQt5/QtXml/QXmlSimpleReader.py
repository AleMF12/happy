# encoding: utf-8
# module PyQt5.QtXml
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtXml.pyd
# by generator 1.147
# no doc
...
class QXmlSimpleReader(QXmlReader):
    ...
    def property(self, p_str): # real signature unknown; restored from __doc__
        """ property(self, str) -> Tuple[PyQt5.sip.voidptr, bool] """
        pass
    ...
    def setProperty(self, p_str, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ setProperty(self, str, PyQt5.sip.voidptr) """
        pass
