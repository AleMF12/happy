...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtRemoteObjects.pyd
# by generator 1.147
# no doc
...
class QRemoteObjectReplica(__PyQt5_QtCore.QObject):
    ...
    def notified(self): # real signature unknown; restored from __doc__
        """ notified(self) [signal] """
        pass
...
class QRemoteObjectHost(QRemoteObjectHostBase):
    ...
    def hostUrlChanged(self): # real signature unknown; restored from __doc__
        """ hostUrlChanged(self) [signal] """
        pass
