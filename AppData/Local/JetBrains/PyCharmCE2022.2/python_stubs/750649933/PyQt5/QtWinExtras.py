...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtWinExtras.pyd
# by generator 1.147
# no doc
...
class QtWin(__sip.simplewrapper):
    ...
    def createMask(self, QBitmap): # real signature unknown; restored from __doc__
        """ createMask(QBitmap) -> PyQt5.sip.voidptr """
        pass
    ...
    def fromHBITMAP(self, PyQt5_sip_voidptr, format=None): # real signature unknown; restored from __doc__
        """ fromHBITMAP(PyQt5.sip.voidptr, format: QtWin.HBitmapFormat = QtWin.HBitmapNoAlpha) -> QPixmap """
        pass

    def fromHICON(self, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ fromHICON(PyQt5.sip.voidptr) -> QPixmap """
        pass

    def fromHRGN(self, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ fromHRGN(PyQt5.sip.voidptr) -> QRegion """
        pass

    def imageFromHBITMAP(self, PyQt5_sip_voidptr, PyQt5_sip_voidptr_1, p_int, p_int_1): # real signature unknown; restored from __doc__
        """ imageFromHBITMAP(PyQt5.sip.voidptr, PyQt5.sip.voidptr, int, int) -> QImage """
        pass
    ...
    def toHBITMAP(self, QPixmap, format=None): # real signature unknown; restored from __doc__
        """ toHBITMAP(QPixmap, format: QtWin.HBitmapFormat = QtWin.HBitmapNoAlpha) -> PyQt5.sip.voidptr """
        pass

    def toHICON(self, QPixmap): # real signature unknown; restored from __doc__
        """ toHICON(QPixmap) -> PyQt5.sip.voidptr """
        pass

    def toHRGN(self, QRegion): # real signature unknown; restored from __doc__
        """ toHRGN(QRegion) -> PyQt5.sip.voidptr """
        pass
