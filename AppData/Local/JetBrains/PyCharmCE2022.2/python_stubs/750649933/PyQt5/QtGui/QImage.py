...
class QImage(QPaintDevice):
    ...
    QImage(PyQt5.sip.voidptr, int, int, QImage.Format)
    QImage(bytes, int, int, int, QImage.Format)
    QImage(PyQt5.sip.voidptr, int, int, int, QImage.Format)
    QImage(List[str])
    ...
    def applyColorTransform(self, QColorTransform): # real signature unknown; restored from __doc__
        """ applyColorTransform(self, QColorTransform) """
        pass
    ...
    def constScanLine(self, p_int): # real signature unknown; restored from __doc__
        """ constScanLine(self, int) -> PyQt5.sip.voidptr """
        pass

    def convertedToColorSpace(self, QColorSpace): # real signature unknown; restored from __doc__
        """ convertedToColorSpace(self, QColorSpace) -> QImage """
        return QImage

    def convertTo(self, QImage_Format, flags, Qt_ImageConversionFlags=None, Qt_ImageConversionFlag=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ convertTo(self, QImage.Format, flags: Union[Qt.ImageConversionFlags, Qt.ImageConversionFlag] = Qt.ImageConversionFlag.AutoColor) """
        pass

    def convertToColorSpace(self, QColorSpace): # real signature unknown; restored from __doc__
        """ convertToColorSpace(self, QColorSpace) """
        pass
    ...
    def fromData(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        fromData(PyQt5.sip.array[bytes], format: str = None) -> QImage
    ...
    def loadFromData(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        loadFromData(self, PyQt5.sip.array[bytes], format: str = None) -> bool
    ...
    def setColorSpace(self, QColorSpace): # real signature unknown; restored from __doc__
        """ setColorSpace(self, QColorSpace) """
        pass
