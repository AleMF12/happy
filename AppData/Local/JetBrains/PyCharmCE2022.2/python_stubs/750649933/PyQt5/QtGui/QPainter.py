...
class QPainter(__sip.simplewrapper):
    ...
    def drawConvexPolygon(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        drawConvexPolygon(self, PyQt5.sip.array[Union[QPointF, QPoint]])
        drawConvexPolygon(self, Union[QPointF, QPoint], *)
        drawConvexPolygon(self, PyQt5.sip.array[QPoint])
    ...
    def drawLines(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        drawLines(self, PyQt5.sip.array[QLineF])
        drawLines(self, QLineF, *)
        drawLines(self, PyQt5.sip.array[Union[QPointF, QPoint]])
        drawLines(self, Union[QPointF, QPoint], *)
        drawLines(self, PyQt5.sip.array[QLine])
        drawLines(self, QLine, *)
        drawLines(self, PyQt5.sip.array[QPoint])
    ...
    def drawPixmapFragments(self, PyQt5_sip_array, QPainter_PixmapFragment=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ drawPixmapFragments(self, PyQt5.sip.array[QPainter.PixmapFragment], QPixmap, hints: QPainter.PixmapFragmentHints = 0) """
        pass
    ...
    def drawPoints(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        drawPoints(self, PyQt5.sip.array[Union[QPointF, QPoint]])
        drawPoints(self, Union[QPointF, QPoint], *)
        drawPoints(self, PyQt5.sip.array[QPoint])
    ...
    def drawPolygon(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        drawPolygon(self, PyQt5.sip.array[Union[QPointF, QPoint]], fillRule: Qt.FillRule = Qt.OddEvenFill)
        drawPolygon(self, Union[QPointF, QPoint], *)
        drawPolygon(self, PyQt5.sip.array[QPoint], fillRule: Qt.FillRule = Qt.OddEvenFill)
    ...
    def drawPolyline(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        drawPolyline(self, PyQt5.sip.array[Union[QPointF, QPoint]])
        drawPolyline(self, Union[QPointF, QPoint], *)
        drawPolyline(self, PyQt5.sip.array[QPoint])
    ...
    def drawRects(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        drawRects(self, PyQt5.sip.array[QRectF])
        drawRects(self, QRectF, *)
        drawRects(self, PyQt5.sip.array[QRect])
