...
class QStyleHints(__PyQt5_QtCore.QObject):
    ...
    def setShowShortcutsInContextMenus(self, bool): # real signature unknown; restored from __doc__
    ...
    def showShortcutsInContextMenusChanged(self, bool): # real signature unknown; restored from __doc__
