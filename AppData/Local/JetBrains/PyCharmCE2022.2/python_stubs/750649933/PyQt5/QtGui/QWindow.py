...
class QWindow(__PyQt5_QtCore.QObject, QSurface):
    ...
    def fromWinId(self, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ fromWinId(PyQt5.sip.voidptr) -> QWindow """
        return QWindow
    ...
    def startSystemResize(self, Union, Qt_Edges=None, Qt_Edge=None): # real signature unknown; restored from __doc__
        """ startSystemResize(self, Union[Qt.Edges, Qt.Edge]) -> bool """
        return False
