...
class QTextCharFormat(QTextFormat):
    ...
    def setFontFamilies(self, Iterable, p_str=None): # real signature unknown; restored from __doc__
    ...
    def setFontStyleName(self, p_str): # real signature unknown; restored from __doc__
