...
class QAbstractTextDocumentLayout(__PyQt5_QtCore.QObject):
    ...
    def blockWithMarkerAt(self, Union, QPointF=None, QPoint=None): # real signature unknown; restored from __doc__
        """ blockWithMarkerAt(self, Union[QPointF, QPoint]) -> QTextBlock """
        return QTextBlock
