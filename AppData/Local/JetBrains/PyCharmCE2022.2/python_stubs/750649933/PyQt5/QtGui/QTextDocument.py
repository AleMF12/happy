...
class QTextDocument(__PyQt5_QtCore.QObject):
    ...
    def setMarkdown(self, p_str, features, QTextDocument_MarkdownFeatures=None, QTextDocument_MarkdownFeature=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setMarkdown(self, str, features: Union[QTextDocument.MarkdownFeatures, QTextDocument.MarkdownFeature] = QTextDocument.MarkdownDialectGitHub) """
        pass
