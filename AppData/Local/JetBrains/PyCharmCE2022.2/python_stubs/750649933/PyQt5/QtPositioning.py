...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtPositioning.pyd
# by generator 1.147
# no doc
...
class QGeoPositionInfoSource(__PyQt5_QtCore.QObject):
    ...
    def backendProperty(self, p_str): # real signature unknown; restored from __doc__
        """ backendProperty(self, str) -> Any """
        pass
    ...
    def createDefaultSource(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        createDefaultSource(Dict[str, Any], QObject) -> QGeoPositionInfoSource
        """
        return QGeoPositionInfoSource

    def createSource(self, p_str, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        createSource(str, QObject) -> QGeoPositionInfoSource
        createSource(str, Dict[str, Any], QObject) -> QGeoPositionInfoSource
        """
        return QGeoPositionInfoSource
    ...
    def setBackendProperty(self, p_str, Any): # real signature unknown; restored from __doc__
        """ setBackendProperty(self, str, Any) -> bool """
        return False
...
class QNmeaPositionInfoSource(QGeoPositionInfoSource):
    ...
    def parsePosInfoFromNmeaData(self, bytes, p_int, QGeoPositionInfo): # real signature unknown; restored from __doc__
        """ parsePosInfoFromNmeaData(self, bytes, int, QGeoPositionInfo) -> Tuple[bool, bool] """
        pass
