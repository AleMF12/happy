...
class QAbstractSocket(__PyQt5_QtCore.QIODevice):
    ...
    def errorOccurred(self, QAbstractSocket_SocketError): # real signature unknown; restored from __doc__
        """ errorOccurred(self, QAbstractSocket.SocketError) [signal] """
        pass
    ...
    def setSocketDescriptor(self, PyQt5_sip_voidptr, state=None, mode, QIODevice_OpenMode=None, QIODevice_OpenModeFlag=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setSocketDescriptor(self, PyQt5.sip.voidptr, state: QAbstractSocket.SocketState = QAbstractSocket.ConnectedState, mode: Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = QIODevice.ReadWrite) -> bool """
        pass
