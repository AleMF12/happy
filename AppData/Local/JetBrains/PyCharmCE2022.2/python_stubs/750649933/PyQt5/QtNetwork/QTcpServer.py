...
class QTcpServer(__PyQt5_QtCore.QObject):
    ...
    def incomingConnection(self, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ incomingConnection(self, PyQt5.sip.voidptr) """
        pass
    ...
    def setSocketDescriptor(self, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ setSocketDescriptor(self, PyQt5.sip.voidptr) -> bool """
        return False
