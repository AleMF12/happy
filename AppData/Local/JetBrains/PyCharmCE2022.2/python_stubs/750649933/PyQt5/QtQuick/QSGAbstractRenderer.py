...
class QSGAbstractRenderer(__PyQt5_QtCore.QObject):
    ...
    def setProjectionMatrixToRect(self, QRectF, Union=None, QSGAbstractRenderer_MatrixTransformFlags=None, QSGAbstractRenderer_MatrixTransformFlag=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setProjectionMatrixToRect(self, QRectF)
        setProjectionMatrixToRect(self, QRectF, Union[QSGAbstractRenderer.MatrixTransformFlags, QSGAbstractRenderer.MatrixTransformFlag])
        """
        pass
