...
class FragmentScanOptions(__pyarrow_lib._Weakrefable):
    """
    FragmentScanOptions()
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ FragmentScanOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ FragmentScanOptions.__setstate_cython__(self, __pyx_state) """
        pass
    ...
    __hash__ = None
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001F3486BAD80>'
