...
class PartitioningFactory(__pyarrow_lib._Weakrefable):
    """ PartitioningFactory() """
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ PartitioningFactory.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ PartitioningFactory.__setstate_cython__(self, __pyx_state) """
        pass

    type_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001F3486BAFC0>'
