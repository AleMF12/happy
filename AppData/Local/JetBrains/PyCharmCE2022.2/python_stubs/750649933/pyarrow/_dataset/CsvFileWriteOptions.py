...
class CsvFileWriteOptions(FileWriteOptions):
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ CsvFileWriteOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ CsvFileWriteOptions.__setstate_cython__(self, __pyx_state) """
        pass

    write_options = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001F348705390>'
