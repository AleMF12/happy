...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pyarrow\_parquet.cp39-win_amd64.pyd
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import io as io # C:\Users\#Ale\.conda\envs\GCS10004\lib\io.py
...
class ColumnChunkMetaData(__pyarrow_lib._Weakrefable):
    ...
    __hash__ = None
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000020C60DEA7B0>'
...
class FileDecryptionProperties(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000020C60DEA870>'
...
class FileEncryptionProperties(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000020C60DEA690>'
...
class FileMetaData(__pyarrow_lib._Weakrefable):
    ...
    __hash__ = None
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000020C60DEA720>'
...
class ParquetLogicalType(__pyarrow_lib._Weakrefable):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000020C60DEA8D0>'
...
class ParquetReader(__pyarrow_lib._Weakrefable):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000020C60DEA960>'
...
class Statistics(__pyarrow_lib._Weakrefable):
    ...
    __hash__ = None
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000020C60DEA810>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020C527ACA00>'

__pyx_capi__ = {
    '_create_arrow_writer_properties': None, # (!) real value is '<capsule object "std::shared_ptr<parquet::ArrowWriterProperties>  (struct __pyx_opt_args_7pyarrow_8_parquet__create_arrow_writer_properties *__pyx_optional_args)" at 0x0000020C60DEA630>'
    '_create_writer_properties': None, # (!) real value is '<capsule object "std::shared_ptr<parquet::WriterProperties>  (struct __pyx_opt_args_7pyarrow_8_parquet__create_writer_properties *__pyx_optional_args)" at 0x0000020C60DEA600>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pyarrow._parquet', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020C527ACA00>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pyarrow\\\\_parquet.cp39-win_amd64.pyd')"
