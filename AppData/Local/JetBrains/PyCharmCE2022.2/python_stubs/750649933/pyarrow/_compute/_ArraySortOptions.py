...
class _ArraySortOptions(FunctionOptions):
    # no doc
    def _set_options(self, order, null_placement): # real signature unknown; restored from __doc__
        """ _ArraySortOptions._set_options(self, order, null_placement) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _ArraySortOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _ArraySortOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CE70>'
