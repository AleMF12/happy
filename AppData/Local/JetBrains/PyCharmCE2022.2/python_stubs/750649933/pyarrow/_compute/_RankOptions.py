...
class _RankOptions(FunctionOptions):
    # no doc
    def _set_options(self, sort_keys, null_placement, tiebreaker): # real signature unknown; restored from __doc__
        """ _RankOptions._set_options(self, sort_keys, null_placement, tiebreaker) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _RankOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _RankOptions.__setstate_cython__(self, __pyx_state) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D35150>'
