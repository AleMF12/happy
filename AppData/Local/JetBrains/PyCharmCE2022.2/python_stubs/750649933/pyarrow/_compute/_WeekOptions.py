...
class _WeekOptions(FunctionOptions):
    # no doc
    def _set_options(self, week_starts_monday, count_from_zero, first_week_is_fully_in_year): # real signature unknown; restored from __doc__
        """ _WeekOptions._set_options(self, week_starts_monday, count_from_zero, first_week_is_fully_in_year) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _WeekOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _WeekOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CB70>'
