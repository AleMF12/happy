...
class _ReplaceSubstringOptions(FunctionOptions):
    # no doc
    def _set_options(self, pattern, replacement, max_replacements): # real signature unknown; restored from __doc__
        """ _ReplaceSubstringOptions._set_options(self, pattern, replacement, max_replacements) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _ReplaceSubstringOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _ReplaceSubstringOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C4B0>'
