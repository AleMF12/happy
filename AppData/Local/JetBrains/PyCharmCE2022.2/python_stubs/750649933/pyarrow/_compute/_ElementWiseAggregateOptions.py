...
class _ElementWiseAggregateOptions(FunctionOptions):
    # no doc
    def _set_options(self, skip_nulls): # real signature unknown; restored from __doc__
        """ _ElementWiseAggregateOptions._set_options(self, skip_nulls) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _ElementWiseAggregateOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _ElementWiseAggregateOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C1B0>'
