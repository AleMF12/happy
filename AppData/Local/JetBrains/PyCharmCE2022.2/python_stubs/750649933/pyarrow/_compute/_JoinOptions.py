...
class _JoinOptions(FunctionOptions):
    # no doc
    def _set_options(self, null_handling, null_replacement): # real signature unknown; restored from __doc__
        """ _JoinOptions._set_options(self, null_handling, null_replacement) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _JoinOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _JoinOptions.__setstate_cython__(self, __pyx_state) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C330>'
