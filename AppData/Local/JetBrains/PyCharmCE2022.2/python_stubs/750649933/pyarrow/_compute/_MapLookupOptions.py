...
class _MapLookupOptions(FunctionOptions):
    # no doc
    def _set_options(self, query_key, occurrence): # real signature unknown; restored from __doc__
        """ _MapLookupOptions._set_options(self, query_key, occurrence) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _MapLookupOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _MapLookupOptions.__setstate_cython__(self, __pyx_state) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C930>'
