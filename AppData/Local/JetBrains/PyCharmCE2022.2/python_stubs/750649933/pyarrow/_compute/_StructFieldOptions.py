...
class _StructFieldOptions(FunctionOptions):
    # no doc
    def _set_options(self, indices): # real signature unknown; restored from __doc__
        """ _StructFieldOptions._set_options(self, indices) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _StructFieldOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _StructFieldOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C7B0>'
