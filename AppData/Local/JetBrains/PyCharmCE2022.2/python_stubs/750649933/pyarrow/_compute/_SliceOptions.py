...
class _SliceOptions(FunctionOptions):
    # no doc
    def _set_options(self, start, stop, step): # real signature unknown; restored from __doc__
        """ _SliceOptions._set_options(self, start, stop, step) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _SliceOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _SliceOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C570>'
