...
class _StrftimeOptions(FunctionOptions):
    # no doc
    def _set_options(self, format, locale): # real signature unknown; restored from __doc__
        """ _StrftimeOptions._set_options(self, format, locale) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _StrftimeOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _StrftimeOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CAB0>'
