...
class _SortOptions(FunctionOptions):
    ...
    def _set_options(self, sort_keys, null_placement): # real signature unknown; restored from __doc__
        """ _SortOptions._set_options(self, sort_keys, null_placement) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _SortOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _SortOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CED0>'
