...
class _TakeOptions(FunctionOptions):
    # no doc
    def _set_options(self, boundscheck): # real signature unknown; restored from __doc__
        """ _TakeOptions._set_options(self, boundscheck) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _TakeOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _TakeOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C6F0>'
