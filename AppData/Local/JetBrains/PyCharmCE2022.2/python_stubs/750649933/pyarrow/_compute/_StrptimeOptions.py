...
class _StrptimeOptions(FunctionOptions):
    # no doc
    def _set_options(self, format, unit, error_is_null): # real signature unknown; restored from __doc__
        """ _StrptimeOptions._set_options(self, format, unit, error_is_null) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _StrptimeOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _StrptimeOptions.__setstate_cython__(self, __pyx_state) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CA50>'
