...
class _ReplaceSliceOptions(FunctionOptions):
    # no doc
    def _set_options(self, start, stop, replacement): # real signature unknown; restored from __doc__
        """ _ReplaceSliceOptions._set_options(self, start, stop, replacement) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _ReplaceSliceOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _ReplaceSliceOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C5D0>'
