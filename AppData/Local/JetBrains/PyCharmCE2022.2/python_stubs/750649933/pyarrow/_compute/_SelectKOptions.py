...
class _SelectKOptions(FunctionOptions):
    # no doc
    def _set_options(self, k, sort_keys): # real signature unknown; restored from __doc__
        """ _SelectKOptions._set_options(self, k, sort_keys) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _SelectKOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _SelectKOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CF30>'
