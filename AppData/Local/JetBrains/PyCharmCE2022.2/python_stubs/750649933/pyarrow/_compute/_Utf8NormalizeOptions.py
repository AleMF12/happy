...
class _Utf8NormalizeOptions(FunctionOptions):
    # no doc
    def _set_options(self, form): # real signature unknown; restored from __doc__
        """ _Utf8NormalizeOptions._set_options(self, form) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _Utf8NormalizeOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _Utf8NormalizeOptions.__setstate_cython__(self, __pyx_state) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D35090>'
