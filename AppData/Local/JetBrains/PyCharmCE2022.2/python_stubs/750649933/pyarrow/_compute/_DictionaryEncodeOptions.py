...
class _DictionaryEncodeOptions(FunctionOptions):
    # no doc
    def _set_options(self, null_encoding): # real signature unknown; restored from __doc__
        """ _DictionaryEncodeOptions._set_options(self, null_encoding) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _DictionaryEncodeOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _DictionaryEncodeOptions.__setstate_cython__(self, __pyx_state) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C690>'
