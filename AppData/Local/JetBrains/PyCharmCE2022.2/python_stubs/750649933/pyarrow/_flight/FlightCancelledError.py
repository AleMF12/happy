...
class FlightCancelledError(FlightError, __pyarrow_lib.ArrowCancelled):
    ...
    def __reduce_cython__(self): # real signature unknown; restored from __doc__
        """ FlightCancelledError.__reduce_cython__(self) """
        pass

    def __setstate_cython__(self, __pyx_state): # real signature unknown; restored from __doc__
        """ FlightCancelledError.__setstate_cython__(self, __pyx_state) """
        pass

    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x00007FFF94B3E5C0>, '__reduce_cython__': <method '__reduce_cython__' of 'pyarrow._flight.FlightCancelledError' objects>, '__setstate_cython__': <method '__setstate_cython__' of 'pyarrow._flight.FlightCancelledError' objects>, '__dict__': <attribute '__dict__' of 'pyarrow._flight.FlightCancelledError' objects>, '__doc__': 'The operation was cancelled.', '__pyx_vtable__': <capsule object NULL at 0x000002D412573EA0>})"
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D412573EA0>'
