...
class _ServerMiddlewareFactoryWrapper(ServerMiddlewareFactory):
    ...
    def start_call(self, info, headers): # real signature unknown; restored from __doc__
        """ _ServerMiddlewareFactoryWrapper.start_call(self, info, headers) """
        pass

    def __init__(self, dict_factories): # real signature unknown; restored from __doc__
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _ServerMiddlewareFactoryWrapper.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _ServerMiddlewareFactoryWrapper.__setstate_cython__(self, __pyx_state) """
        pass
