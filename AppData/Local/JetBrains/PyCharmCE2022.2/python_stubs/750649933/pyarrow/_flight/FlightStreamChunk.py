...
class FlightStreamChunk(__pyarrow_lib._Weakrefable):
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ FlightStreamChunk.__reduce_cython__(self) """
        pass
    ...
    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ FlightStreamChunk.__setstate_cython__(self, __pyx_state) """
        pass

    app_metadata = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
