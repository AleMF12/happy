...
class Ticket(__pyarrow_lib._Weakrefable):
    """
    Ticket(ticket)
    ...
    def deserialize(cls, type_cls, serialized): # real signature unknown; restored from __doc__
        """
        Ticket.deserialize(type cls, serialized)
    ...
    def __init__(self, ticket): # real signature unknown; restored from __doc__
        pass
    ...
    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ Ticket.__setstate_cython__(self, __pyx_state) """
        pass
