...
class BaseExtensionType(DataType):
    ...
    def wrap_array(self, storage): # real signature unknown; restored from __doc__
        """
    ...
    extension_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """
        The extension type name.
        """

    storage_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """
        The underlying storage type.
        """


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D88CEBFEA0>'
