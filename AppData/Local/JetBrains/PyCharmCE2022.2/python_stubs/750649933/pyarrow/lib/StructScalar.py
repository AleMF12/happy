...
class StructScalar(Scalar, __collections_abc.Mapping):
    ...
    def _as_py_tuple(self): # real signature unknown; restored from __doc__
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D89D1AF120>'
