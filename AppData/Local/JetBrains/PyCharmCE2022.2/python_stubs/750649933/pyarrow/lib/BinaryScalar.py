...
class BinaryScalar(Scalar):
    ...
    def as_buffer(self): # real signature unknown; restored from __doc__
        """
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D88CE53E70>'
