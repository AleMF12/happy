...
class VersionInfo(tuple):
    ...
    def __init__(self, major, minor, patch): # real signature unknown; restored from __doc__
        pass

    @staticmethod # known case of __new__
    def __new__(_cls, major, minor, patch): # reliably restored by inspect
        """ Create new instance of VersionInfo(major, minor, patch) """
        pass
    ...
    major = _tuplegetter(0, 'Alias for field number 0')
    minor = _tuplegetter(1, 'Alias for field number 1')
    patch = _tuplegetter(2, 'Alias for field number 2')
    _fields = (
        'major',
        'minor',
        'patch',
