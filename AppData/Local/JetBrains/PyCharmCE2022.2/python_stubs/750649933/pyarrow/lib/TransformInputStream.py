...
class TransformInputStream(NativeFile):
    ...
    """
    def __init__(self, NativeFile_stream, transform_func): # real signature unknown; restored from __doc__
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ TransformInputStream.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ TransformInputStream.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D88CE4B300>'
