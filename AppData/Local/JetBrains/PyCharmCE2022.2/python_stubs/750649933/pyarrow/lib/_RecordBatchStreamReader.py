...
class _RecordBatchStreamReader(RecordBatchReader):
    # no doc
    def _open(self, source, IpcReadOptions_options=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ _RecordBatchStreamReader._open(self, source, IpcReadOptions options=IpcReadOptions(), MemoryPool memory_pool=None) """
        pass
