...
class TableGroupBy(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pyarrow.lib\', \'__doc__\': \'\\n    A grouping of columns in a table on which to perform aggregations.\\n\\n    Parameters\\n    ----------\\n    table : pyarrow.Table\\n        Input table to execute the aggregation on.\\n    keys : str or list[str]\\n        Name of the grouped columns.\\n\\n    Examples\\n    --------\\n    >>> import pyarrow as pa\\n    >>> t = pa.table([\\n    ...       pa.array(["a", "a", "b", "b", "c"]),\\n    ...       pa.array([1, 2, 3, 4, 5]),\\n    ... ], names=["keys", "values"])\\n\\n    Grouping of columns:\\n\\n    >>> pa.TableGroupBy(t,"keys")\\n    <pyarrow.lib.TableGroupBy object at ...>\\n\\n    Perform aggregations:\\n\\n    >>> pa.TableGroupBy(t,"keys").aggregate([("values", "sum")])\\n    pyarrow.Table\\n    values_sum: int64\\n    keys: string\\n    ----\\n    values_sum: [[3,7,5]]\\n    keys: [["a","b","c"]]\\n    \', \'__init__\': <cyfunction TableGroupBy.__init__ at 0x000002D89D16E380>, \'aggregate\': <cyfunction TableGroupBy.aggregate at 0x000002D89D16E520>, \'__dict__\': <attribute \'__dict__\' of \'TableGroupBy\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'TableGroupBy\' objects>})'
