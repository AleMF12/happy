...
class _ExtensionRegistryNanny(_Weakrefable):
    # no doc
    def release_registry(self): # real signature unknown; restored from __doc__
        """ _ExtensionRegistryNanny.release_registry(self) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _ExtensionRegistryNanny.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _ExtensionRegistryNanny.__setstate_cython__(self, __pyx_state) """
        pass
