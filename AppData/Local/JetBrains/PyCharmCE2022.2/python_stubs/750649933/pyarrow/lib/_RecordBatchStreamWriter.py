...
class _RecordBatchStreamWriter(_CRecordBatchWriter):
    # no doc
    def _open(self, sink, Schema_schema, IpcWriteOptions_options=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ _RecordBatchStreamWriter._open(self, sink, Schema schema, IpcWriteOptions options=IpcWriteOptions()) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _RecordBatchStreamWriter.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _RecordBatchStreamWriter.__setstate_cython__(self, __pyx_state) """
        pass

    _metadata_version = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _use_legacy_format = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
