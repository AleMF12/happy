...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pyarrow\_s3fs.cp39-win_amd64.pyd
# by generator 1.147
# no doc
...
class S3RetryStrategy(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pyarrow._s3fs', '__doc__': '\\n    Base class for AWS retry strategies for use with S3.\\n\\n    Parameters\\n    ----------\\n    max_attempts : int, default 3\\n        The maximum number of retry attempts to attempt before failing.\\n    ', '__init__': <cyfunction S3RetryStrategy.__init__ at 0x000001C3F6E05380>, '__dict__': <attribute '__dict__' of 'S3RetryStrategy' objects>, '__weakref__': <attribute '__weakref__' of 'S3RetryStrategy' objects>})"
...
class S3FileSystem(__pyarrow__fs.FileSystem):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001C3E877CA50>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C3E877CA00>'

__spec__ = None # (!) real value is "ModuleSpec(name='pyarrow._s3fs', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C3E877CA00>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pyarrow\\\\_s3fs.cp39-win_amd64.pyd')"
