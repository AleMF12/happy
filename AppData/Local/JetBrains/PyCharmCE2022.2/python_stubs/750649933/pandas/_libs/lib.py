...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pandas\_libs\lib.cp39-win_amd64.pyd
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import collections.abc as abc # C:\Users\#Ale\.conda\envs\GCS10004\lib\collections\abc.py
...
class Enum(object):
    ...
    name = None # (!) real value is '<types.DynamicClassAttribute object at 0x00000111EA31D850>'
    value = None # (!) real value is '<types.DynamicClassAttribute object at 0x00000111EA31D880>'
    _member_map_ = {}
    _member_names_ = []
    _member_type_ = object
    _value2member_map_ = {}
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'enum', '__doc__': '\\n    Generic enumeration.\\n\\n    Derive from this class to define new enumerations.\\n    ', '__new__': <staticmethod object at 0x00000111EA31D970>, '_generate_next_value_': <function Enum._generate_next_value_ at 0x00000111EA324310>, '_missing_': <classmethod object at 0x00000111EA31D820>, '__repr__': <function Enum.__repr__ at 0x00000111EA324430>, '__str__': <function Enum.__str__ at 0x00000111EA3244C0>, '__dir__': <function Enum.__dir__ at 0x00000111EA324550>, '__format__': <function Enum.__format__ at 0x00000111EA3245E0>, '__hash__': <function Enum.__hash__ at 0x00000111EA324670>, '__reduce_ex__': <function Enum.__reduce_ex__ at 0x00000111EA324700>, 'name': <types.DynamicClassAttribute object at 0x00000111EA31D850>, 'value': <types.DynamicClassAttribute object at 0x00000111EA31D880>, '__dict__': <attribute '__dict__' of 'Enum' objects>, '__weakref__': <attribute '__weakref__' of 'Enum' objects>, '_member_names_': [], '_member_map_': {}, '_member_type_': <class 'object'>, '_value2member_map_': {}})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000111FB530F70>'

__pyx_capi__ = {
    'c_is_list_like': None, # (!) real value is '<capsule object "int (PyObject *, int)" at 0x00000111FB55AE70>'
    'eq_NA_compat': None, # (!) real value is '<capsule object "PyArrayObject *(PyArrayObject *, PyObject *, int __pyx_skip_dispatch)" at 0x00000111FB55AEA0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.lib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000111FB530F70>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\lib.cp39-win_amd64.pyd')"

__test__ = {
    'infer_dtype (line 1351)': "\n    Return a string label of the type of a scalar or list-like of values.\n\n    Parameters\n    ----------\n    value : scalar, list, ndarray, or pandas type\n    skipna : bool, default True\n        Ignore NaN values when inferring the type.\n\n    Returns\n    -------\n    str\n        Describing the common type of the input data.\n    Results can include:\n\n    - string\n    - bytes\n    - floating\n    - integer\n    - mixed-integer\n    - mixed-integer-float\n    - decimal\n    - complex\n    - categorical\n    - boolean\n    - datetime64\n    - datetime\n    - date\n    - timedelta64\n    - timedelta\n    - time\n    - period\n    - mixed\n    - unknown-array\n\n    Raises\n    ------\n    TypeError\n        If ndarray-like but cannot infer the dtype\n\n    Notes\n    -----\n    - 'mixed' is the catchall for anything that is not otherwise\n      specialized\n    - 'mixed-integer-float' are floats and integers\n    - 'mixed-integer' are integers mixed with non-integers\n    - 'unknown-array' is the catchall for something that *is* an array (has\n      a dtype attribute), but has a dtype unknown to pandas (e.g. external\n      extension array)\n\n    Examples\n    --------\n    >>> import datetime\n    >>> infer_dtype(['foo', 'bar'])\n    'string'\n\n    >>> infer_dtype(['a', np.nan, 'b'], skipna=True)\n    'string'\n\n    >>> infer_dtype(['a', np.nan, 'b'], skipna=False)\n    'mixed'\n\n    >>> infer_dtype([b'foo', b'bar'])\n    'bytes'\n\n    >>> infer_dtype([1, 2, 3])\n    'integer'\n\n    >>> infer_dtype([1, 2, 3.5])\n    'mixed-integer-float'\n\n    >>> infer_dtype([1.0, 2.0, 3.5])\n    'floating'\n\n    >>> infer_dtype(['a', 1])\n    'mixed-integer'\n\n    >>> infer_dtype([Decimal(1), Decimal(2.0)])\n    'decimal'\n\n    >>> infer_dtype([True, False])\n    'boolean'\n\n    >>> infer_dtype([True, False, np.nan])\n    'boolean'\n\n    >>> infer_dtype([pd.Timestamp('20130101')])\n    'datetime'\n\n    >>> infer_dtype([datetime.date(2013, 1, 1)])\n    'date'\n\n    >>> infer_dtype([np.datetime64('2013-01-01')])\n    'datetime64'\n\n    >>> infer_dtype([datetime.timedelta(0, 1, 1)])\n    'timedelta'\n\n    >>> infer_dtype(pd.Series(list('aabc')).astype('category'))\n    'categorical'\n    ",
    'is_iterator (line 255)': '\n    Check if the object is an iterator.\n\n    This is intended for generators, not list-like objects.\n\n    Parameters\n    ----------\n    obj : The object to check\n\n    Returns\n    -------\n    is_iter : bool\n        Whether `obj` is an iterator.\n\n    Examples\n    --------\n    >>> import datetime\n    >>> is_iterator((x for x in []))\n    True\n    >>> is_iterator([1, 2, 3])\n    False\n    >>> is_iterator(datetime.datetime(2017, 1, 1))\n    False\n    >>> is_iterator("foo")\n    False\n    >>> is_iterator(1)\n    False\n    ',
    'is_list_like (line 1085)': '\n    Check if the object is list-like.\n\n    Objects that are considered list-like are for example Python\n    lists, tuples, sets, NumPy arrays, and Pandas Series.\n\n    Strings and datetime objects, however, are not considered list-like.\n\n    Parameters\n    ----------\n    obj : object\n        Object to check.\n    allow_sets : bool, default True\n        If this parameter is False, sets will not be considered list-like.\n\n    Returns\n    -------\n    bool\n        Whether `obj` has list-like properties.\n\n    Examples\n    --------\n    >>> import datetime\n    >>> is_list_like([1, 2, 3])\n    True\n    >>> is_list_like({1, 2, 3})\n    True\n    >>> is_list_like(datetime.datetime(2017, 1, 1))\n    False\n    >>> is_list_like("foo")\n    False\n    >>> is_list_like(1)\n    False\n    >>> is_list_like(np.array([2]))\n    True\n    >>> is_list_like(np.array(2))\n    False\n    ',
    'is_scalar (line 161)': '\n    Return True if given object is scalar.\n\n    Parameters\n    ----------\n    val : object\n        This includes:\n\n        - numpy array scalar (e.g. np.int64)\n        - Python builtin numerics\n        - Python builtin byte arrays and strings\n        - None\n        - datetime.datetime\n        - datetime.timedelta\n        - Period\n        - decimal.Decimal\n        - Interval\n        - DateOffset\n        - Fraction\n        - Number.\n\n    Returns\n    -------\n    bool\n        Return True if given object is scalar.\n\n    Examples\n    --------\n    >>> import datetime\n    >>> dt = datetime.datetime(2018, 10, 3)\n    >>> pd.api.types.is_scalar(dt)\n    True\n\n    >>> pd.api.types.is_scalar([2, 3])\n    False\n\n    >>> pd.api.types.is_scalar({0: 1, 2: 3})\n    False\n\n    >>> pd.api.types.is_scalar((0, 2))\n    False\n\n    pandas supports PEP 3141 numbers:\n\n    >>> from fractions import Fraction\n    >>> pd.api.types.is_scalar(Fraction(3, 5))\n    True\n    ',
    'item_from_zerodim (line 287)': "\n    If the value is a zerodim array, return the item it contains.\n\n    Parameters\n    ----------\n    val : object\n\n    Returns\n    -------\n    object\n\n    Examples\n    --------\n    >>> item_from_zerodim(1)\n    1\n    >>> item_from_zerodim('foobar')\n    'foobar'\n    >>> item_from_zerodim(np.array(1))\n    1\n    >>> item_from_zerodim(np.array([1]))\n    array([1])\n    ",
}
