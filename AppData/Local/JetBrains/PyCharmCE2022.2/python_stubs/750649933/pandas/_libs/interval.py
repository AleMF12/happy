...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pandas\_libs\interval.cp39-win_amd64.pyd
# by generator 1.147
# no doc
...
VALID_CLOSED = None # (!) real value is "frozenset({'neither', 'both', 'right', 'left'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001B4DDFB0A90>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.interval', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001B4DDFB0A90>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\interval.cp39-win_amd64.pyd')"
