...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pandas\_libs\tslibs\period.cp39-win_amd64.pyd
# by generator 1.147
# no doc
...
class Period(_Period):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.period\', \'__doc__\': "\\n    Represents a period of time.\\n\\n    Parameters\\n    ----------\\n    value : Period or str, default None\\n        The time period represented (e.g., \'4Q2005\'). This represents neither\\n        the start or the end of the period, but rather the entire period itself.\\n    freq : str, default None\\n        One of pandas period strings or corresponding objects. Accepted\\n        strings are listed in the :ref:`offset alias section <timeseries.offset_aliases>` in the user docs.\\n    ordinal : int, default None\\n        The period offset from the proleptic Gregorian epoch.\\n    year : int, default None\\n        Year value of the period.\\n    month : int, default 1\\n        Month value of the period.\\n    quarter : int, default None\\n        Quarter value of the period.\\n    day : int, default 1\\n        Day value of the period.\\n    hour : int, default 0\\n        Hour value of the period.\\n    minute : int, default 0\\n        Minute value of the period.\\n    second : int, default 0\\n        Second value of the period.\\n\\n    Examples\\n    --------\\n    >>> period = pd.Period(\'2012-1-1\', freq=\'D\')\\n    >>> period\\n    Period(\'2012-01-01\', \'D\')\\n    ", \'__new__\': <cyfunction Period.__new__ at 0x000002536BDBF930>, \'__dict__\': <attribute \'__dict__\' of \'Period\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Period\' objects>})'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002536BDE9850>'

__pyx_capi__ = {
    'get_period_ordinal': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (npy_datetimestruct *, int)" at 0x000002536BE22030>'
    'is_period_object': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x000002536BDE9FC0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.period', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002536BDE9850>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\period.cp39-win_amd64.pyd')"
