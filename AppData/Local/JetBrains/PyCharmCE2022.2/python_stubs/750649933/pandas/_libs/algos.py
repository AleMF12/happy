...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pandas\_libs\algos.cp39-win_amd64.pyd
# by generator 1.147
# no doc
...
import pandas._libs.missing as missing # C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pandas\_libs\missing.cp39-win_amd64.pyd
...
class Infinity(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas._libs.algos', '__doc__': '\\n    Provide a positive Infinity comparison method for ranking.\\n    ', '__lt__': <cyfunction Infinity.<lambda> at 0x000001A72043F790>, '__le__': <cyfunction Infinity.<lambda> at 0x000001A72043F860>, '__eq__': <cyfunction Infinity.<lambda> at 0x000001A72043F930>, '__ne__': <cyfunction Infinity.<lambda> at 0x000001A72043FA00>, '__gt__': <cyfunction Infinity.<lambda> at 0x000001A72043FAD0>, '__ge__': <cyfunction Infinity.<lambda> at 0x000001A72043FBA0>, '__dict__': <attribute '__dict__' of 'Infinity' objects>, '__weakref__': <attribute '__weakref__' of 'Infinity' objects>, '__hash__': None})"
    __hash__ = None
...
class NegInfinity(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas._libs.algos', '__doc__': '\\n    Provide a negative Infinity comparison method for ranking.\\n    ', '__lt__': <cyfunction NegInfinity.<lambda> at 0x000001A72043FC70>, '__le__': <cyfunction NegInfinity.<lambda> at 0x000001A72043FD40>, '__eq__': <cyfunction NegInfinity.<lambda> at 0x000001A72043FE10>, '__ne__': <cyfunction NegInfinity.<lambda> at 0x000001A72043FEE0>, '__gt__': <cyfunction NegInfinity.<lambda> at 0x000001A72044F040>, '__ge__': <cyfunction NegInfinity.<lambda> at 0x000001A72044F110>, '__dict__': <attribute '__dict__' of 'NegInfinity' objects>, '__weakref__': <attribute '__weakref__' of 'NegInfinity' objects>, '__hash__': None})"
    __hash__ = None
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A720431FD0>'

__pyx_capi__ = {
    '__pyx_fuse_0get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int8_t (int, __pyx_t_5numpy_int8_t, struct __pyx_fuse_0__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A720444510>'
    '__pyx_fuse_0kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int8_t (__pyx_t_5numpy_int8_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A720444330>'
    '__pyx_fuse_10get_rank_nan_fill_val': None, # (!) real value is '<capsule object "PyObject *(int, PyObject *, struct __pyx_fuse_10__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A7204446F0>'
    '__pyx_fuse_1get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int16_t (int, __pyx_t_5numpy_int16_t, struct __pyx_fuse_1__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A720444540>'
    '__pyx_fuse_1kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int16_t (__pyx_t_5numpy_int16_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A720444360>'
    '__pyx_fuse_2get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int32_t (int, __pyx_t_5numpy_int32_t, struct __pyx_fuse_2__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A720444570>'
    '__pyx_fuse_2kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int32_t (__pyx_t_5numpy_int32_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A720444390>'
    '__pyx_fuse_3get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (int, __pyx_t_5numpy_int64_t, struct __pyx_fuse_3__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A7204445A0>'
    '__pyx_fuse_3kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (__pyx_t_5numpy_int64_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A7204443C0>'
    '__pyx_fuse_4get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint8_t (int, __pyx_t_5numpy_uint8_t, struct __pyx_fuse_4__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A7204445D0>'
    '__pyx_fuse_4kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint8_t (__pyx_t_5numpy_uint8_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A7204443F0>'
    '__pyx_fuse_5get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint16_t (int, __pyx_t_5numpy_uint16_t, struct __pyx_fuse_5__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A720444600>'
    '__pyx_fuse_5kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint16_t (__pyx_t_5numpy_uint16_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A720444420>'
    '__pyx_fuse_6get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint32_t (int, __pyx_t_5numpy_uint32_t, struct __pyx_fuse_6__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A720444630>'
    '__pyx_fuse_6kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint32_t (__pyx_t_5numpy_uint32_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A720444450>'
    '__pyx_fuse_7get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint64_t (int, __pyx_t_5numpy_uint64_t, struct __pyx_fuse_7__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A720444660>'
    '__pyx_fuse_7kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint64_t (__pyx_t_5numpy_uint64_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A720444480>'
    '__pyx_fuse_8get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_float32_t (int, __pyx_t_5numpy_float32_t, struct __pyx_fuse_8__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A720444690>'
    '__pyx_fuse_8kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_float32_t (__pyx_t_5numpy_float32_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A7204444B0>'
    '__pyx_fuse_9get_rank_nan_fill_val': None, # (!) real value is '<capsule object "__pyx_t_5numpy_float64_t (int, __pyx_t_5numpy_float64_t, struct __pyx_fuse_9__pyx_opt_args_6pandas_5_libs_5algos_get_rank_nan_fill_val *__pyx_optional_args)" at 0x000001A7204446C0>'
    '__pyx_fuse_9kth_smallest_c': None, # (!) real value is '<capsule object "__pyx_t_5numpy_float64_t (__pyx_t_5numpy_float64_t *, Py_ssize_t, Py_ssize_t)" at 0x000001A7204444E0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.algos', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A720431FD0>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\algos.cp39-win_amd64.pyd')"
