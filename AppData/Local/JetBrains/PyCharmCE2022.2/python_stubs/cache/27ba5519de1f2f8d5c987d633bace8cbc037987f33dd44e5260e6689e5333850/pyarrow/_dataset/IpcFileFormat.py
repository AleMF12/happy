...
class IpcFileFormat(FileFormat):
    """ IpcFileFormat() """
    def equals(self, IpcFileFormat_other): # real signature unknown; restored from __doc__
        """ IpcFileFormat.equals(self, IpcFileFormat other) """
        pass
    ...
    def __reduce__(self): # real signature unknown; restored from __doc__
        """ IpcFileFormat.__reduce__(self) """
        pass

    default_extname = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001F348705210>'
