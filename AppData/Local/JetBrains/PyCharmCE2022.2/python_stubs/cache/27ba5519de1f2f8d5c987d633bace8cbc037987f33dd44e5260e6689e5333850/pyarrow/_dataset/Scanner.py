...
class Scanner(__pyarrow_lib._Weakrefable):
    ...
    def from_batches(self, source, Schema_schema=None, bool_use_threads=True, use_async=None, MemoryPool_memory_pool=None, columns=None, Expression_filter=None, int_batch_size=None, FragmentScanOptions_fragment_scan_options=None): # real signature unknown; restored from __doc__
        """
        Scanner.from_batches(source, Schema schema=None, bool use_threads=True, use_async=None, MemoryPool memory_pool=None, columns=None, Expression filter=None, int batch_size=_DEFAULT_BATCH_SIZE, FragmentScanOptions fragment_scan_options=None)
    ...
    def from_dataset(self, Dataset_dataset, bool_use_threads=True, use_async=None, MemoryPool_memory_pool=None, columns=None, Expression_filter=None, int_batch_size=None, int_batch_readahead=None, int_fragment_readahead=None, FragmentScanOptions_fragment_scan_options=None): # real signature unknown; restored from __doc__
        """
        Scanner.from_dataset(Dataset dataset, bool use_threads=True, use_async=None, MemoryPool memory_pool=None, columns=None, Expression filter=None, int batch_size=_DEFAULT_BATCH_SIZE, int batch_readahead=_DEFAULT_BATCH_READAHEAD, int fragment_readahead=_DEFAULT_FRAGMENT_READAHEAD, FragmentScanOptions fragment_scan_options=None)
    ...
    def from_fragment(self, Fragment_fragment, Schema_schema=None, bool_use_threads=True, use_async=None, MemoryPool_memory_pool=None, columns=None, Expression_filter=None, int_batch_size=None, int_batch_readahead=None, FragmentScanOptions_fragment_scan_options=None): # real signature unknown; restored from __doc__
        """
        Scanner.from_fragment(Fragment fragment, Schema schema=None, bool use_threads=True, use_async=None, MemoryPool memory_pool=None, columns=None, Expression filter=None, int batch_size=_DEFAULT_BATCH_SIZE, int batch_readahead=_DEFAULT_BATCH_READAHEAD, FragmentScanOptions fragment_scan_options=None)
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001F348705750>'
