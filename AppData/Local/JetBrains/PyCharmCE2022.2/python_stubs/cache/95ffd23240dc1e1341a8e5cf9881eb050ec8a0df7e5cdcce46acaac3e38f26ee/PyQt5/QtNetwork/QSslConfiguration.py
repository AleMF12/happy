...
class QSslConfiguration(__sip.simplewrapper):
    ...
    def addCaCertificates(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addCaCertificates(self, str, format: QSsl.EncodingFormat = QSsl.Pem, syntax: QSslCertificate.PatternSyntax = QSslCertificate.PatternSyntax.FixedString) -> bool
    ...
    def setOcspStaplingEnabled(self, bool): # real signature unknown; restored from __doc__
