...
class QNetworkAccessManager(__PyQt5_QtCore.QObject):
    ...
    def connectToHostEncrypted(self, p_str, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def setAutoDeleteReplies(self, bool): # real signature unknown; restored from __doc__
        """ setAutoDeleteReplies(self, bool) """
        pass
