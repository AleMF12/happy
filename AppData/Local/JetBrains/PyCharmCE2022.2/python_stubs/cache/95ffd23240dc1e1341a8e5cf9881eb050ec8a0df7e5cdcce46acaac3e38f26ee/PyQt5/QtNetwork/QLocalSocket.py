...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtNetwork.pyd
# by generator 1.147
# no doc
...
class QLocalSocket(__PyQt5_QtCore.QIODevice):
    ...
    def errorOccurred(self, QLocalSocket_LocalSocketError): # real signature unknown; restored from __doc__
        """ errorOccurred(self, QLocalSocket.LocalSocketError) [signal] """
        pass
    ...
    def setSocketDescriptor(self, PyQt5_sip_voidptr, state=None, mode, QIODevice_OpenMode=None, QIODevice_OpenModeFlag=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setSocketDescriptor(self, PyQt5.sip.voidptr, state: QLocalSocket.LocalSocketState = QLocalSocket.ConnectedState, mode: Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = QIODevice.ReadWrite) -> bool """
        pass
    ...
    def writeData(self, PyQt5_sip_array, bytes=None): # real signature unknown; restored from __doc__
        """ writeData(self, PyQt5.sip.array[bytes]) -> int """
        return 0
