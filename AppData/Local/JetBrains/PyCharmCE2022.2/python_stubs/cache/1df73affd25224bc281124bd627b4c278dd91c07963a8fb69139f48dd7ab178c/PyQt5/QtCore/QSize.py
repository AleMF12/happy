...
class QSize(__sip.simplewrapper):
    ...
    def grownBy(self, QMargins): # real signature unknown; restored from __doc__
        """ grownBy(self, QMargins) -> QSize """
        return QSize
    ...
    def shrunkBy(self, QMargins): # real signature unknown; restored from __doc__
        """ shrunkBy(self, QMargins) -> QSize """
        return QSize
