...
class QSizeF(__sip.simplewrapper):
    ...
    def grownBy(self, QMarginsF): # real signature unknown; restored from __doc__
        """ grownBy(self, QMarginsF) -> QSizeF """
        return QSizeF
    ...
    def shrunkBy(self, QMarginsF): # real signature unknown; restored from __doc__
        """ shrunkBy(self, QMarginsF) -> QSizeF """
        return QSizeF
