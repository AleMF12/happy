...
class QWinEventNotifier(QObject):
    ...
    QWinEventNotifier(PyQt5.sip.voidptr, parent: QObject = None)
    """
    def activated(self, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ activated(self, PyQt5.sip.voidptr) [signal] """
        pass
    ...
    def setHandle(self, PyQt5_sip_voidptr): # real signature unknown; restored from __doc__
        """ setHandle(self, PyQt5.sip.voidptr) """
        pass
