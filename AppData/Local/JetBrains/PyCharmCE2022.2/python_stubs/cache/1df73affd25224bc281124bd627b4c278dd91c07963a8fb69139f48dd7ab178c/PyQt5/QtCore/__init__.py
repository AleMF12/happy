...
def qChecksum(PyQt5_sip_array, bytes=None): # real signature unknown; restored from __doc__
    """
    qChecksum(PyQt5.sip.array[bytes]) -> int
    qChecksum(PyQt5.sip.array[bytes], Qt.ChecksumType) -> int
    """
    return 0
...
PYQT_CONFIGURATION = {
    'sip_flags': '-n PyQt5.sip -t Qt_5_15_0 -t WS_WIN',
}
