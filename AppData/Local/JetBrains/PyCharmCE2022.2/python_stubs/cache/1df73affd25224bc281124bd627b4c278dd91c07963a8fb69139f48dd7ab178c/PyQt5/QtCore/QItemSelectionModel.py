...
class QItemSelectionModel(QObject):
    ...
    def columnIntersectsSelection(self, p_int, parent=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ columnIntersectsSelection(self, int, parent: QModelIndex = QModelIndex()) -> bool """
        pass
    ...
    def isColumnSelected(self, p_int, parent=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ isColumnSelected(self, int, parent: QModelIndex = QModelIndex()) -> bool """
        pass

    def isRowSelected(self, p_int, parent=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ isRowSelected(self, int, parent: QModelIndex = QModelIndex()) -> bool """
        pass
    ...
    def rowIntersectsSelection(self, p_int, parent=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ rowIntersectsSelection(self, int, parent: QModelIndex = QModelIndex()) -> bool """
        pass
