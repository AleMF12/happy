...
class QUrl(__sip.simplewrapper):
    ...
    QUrl(QUrl)
    """
    def adjusted(self, Union, QUrl_FormattingOptions=None, QUrl_UrlFormattingOption=None, QUrl_ComponentFormattingOption=None): # real signature unknown; restored from __doc__
        """ adjusted(self, Union[QUrl.FormattingOptions, QUrl.UrlFormattingOption, QUrl.ComponentFormattingOption]) -> QUrl """
        return QUrl
    ...
    def matches(self, QUrl, Union, QUrl_FormattingOptions=None, QUrl_UrlFormattingOption=None, QUrl_ComponentFormattingOption=None): # real signature unknown; restored from __doc__
        """ matches(self, QUrl, Union[QUrl.FormattingOptions, QUrl.UrlFormattingOption, QUrl.ComponentFormattingOption]) -> bool """
        return False
