...
class QByteArray(__sip.simplewrapper):
    ...
    def fromBase64Encoding(self, Union, QByteArray=None, bytes=None, bytearray=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ fromBase64Encoding(Union[QByteArray, bytes, bytearray], options: Union[QByteArray.Base64Options, QByteArray.Base64Option] = QByteArray.Base64Encoding) -> QByteArray.FromBase64Result """
        pass
    ...
    def fromRawData(self, PyQt5_sip_array, bytes=None): # real signature unknown; restored from __doc__
        """ fromRawData(PyQt5.sip.array[bytes]) -> QByteArray """
        return QByteArray
