...
class QJsonDocument(__sip.simplewrapper):
    ...
    QJsonDocument(Iterable[Union[QJsonValue, QJsonValue.Type, Dict[str, QJsonValue], bool, int, float, None, str]])
    ...
    def fromRawData(self, bytes, p_int, validation=None): # real signature unknown; restored from __doc__
        """ fromRawData(bytes, int, validation: QJsonDocument.DataValidation = QJsonDocument.Validate) -> QJsonDocument """
    ...
    def setArray(self, Iterable, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setArray(self, Iterable[Union[QJsonValue, QJsonValue.Type, Dict[str, QJsonValue], bool, int, float, None, str]]) """
        pass
