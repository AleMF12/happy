...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtBluetooth.pyd
# by generator 1.147
# no doc
...
class QBluetoothDeviceInfo(__sip.wrapper):
    ...
    def setServiceUuids(self, Iterable, QBluetoothUuid=None, *args=None, **kwargs=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setServiceUuids(self, Iterable[QBluetoothUuid], QBluetoothDeviceInfo.DataCompleteness)
        setServiceUuids(self, Iterable[QBluetoothUuid])
        """
        pass
...
class QBluetoothUuid(__PyQt5_QtCore.QUuid):
    """
    QBluetoothUuid()
    QBluetoothUuid(QBluetoothUuid.ProtocolUuid)
    QBluetoothUuid(QBluetoothUuid.ServiceClassUuid)
    QBluetoothUuid(QBluetoothUuid.CharacteristicType)
...
class QLowEnergyController(__PyQt5_QtCore.QObject):
    ...
    def createCentral(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
