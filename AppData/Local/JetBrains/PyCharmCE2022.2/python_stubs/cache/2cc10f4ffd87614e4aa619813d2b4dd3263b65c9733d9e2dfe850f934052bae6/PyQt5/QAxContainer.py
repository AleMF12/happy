...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QAxContainer.pyd
# by generator 1.147
# no doc
...
class QAxBase(__sip.simplewrapper):
    ...
    def setClassContext(self, p_int): # real signature unknown; restored from __doc__
        """ setClassContext(self, int) """
        pass
