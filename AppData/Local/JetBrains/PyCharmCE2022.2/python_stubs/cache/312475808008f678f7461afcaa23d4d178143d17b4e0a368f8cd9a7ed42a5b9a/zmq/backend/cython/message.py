...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\zmq\backend\cython\message.cp39-win_amd64.pyd
# by generator 1.147
...
class Event(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'threading', '__doc__': 'Class implementing event objects.\\n\\n    Events manage a flag that can be set to true with the set() method and reset\\n    to false with the clear() method. The wait() method blocks until the flag is\\n    true.  The flag is initially false.\\n\\n    ', '__init__': <function Event.__init__ at 0x000002573DB21CA0>, '_at_fork_reinit': <function Event._at_fork_reinit at 0x000002573DB21D30>, 'is_set': <function Event.is_set at 0x000002573DB21DC0>, 'isSet': <function Event.is_set at 0x000002573DB21DC0>, 'set': <function Event.set at 0x000002573DB21E50>, 'clear': <function Event.clear at 0x000002573DB21EE0>, 'wait': <function Event.wait at 0x000002573DB21F70>, '__dict__': <attribute '__dict__' of 'Event' objects>, '__weakref__': <attribute '__weakref__' of 'Event' objects>})"
...
class Message(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002573FDCECF0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002573FDCED90>'

__spec__ = None # (!) real value is "ModuleSpec(name='zmq.backend.cython.message', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002573FDCED90>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\zmq\\\\backend\\\\cython\\\\message.cp39-win_amd64.pyd')"
