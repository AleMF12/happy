...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pandas\_libs\parsers.cp39-win_amd64.pyd
# by generator 1.147
# no doc
...
import pandas._libs.lib as lib # C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pandas\_libs\lib.cp39-win_amd64.pyd
...
class CategoricalDtype(__pandas_core_dtypes_dtypes.PandasExtensionDtype, __pandas_core_dtypes_base.ExtensionDtype):
    ...
    _cache_dtypes = {}
    _hash_categories = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x0000022B7FE7A840>'
    _metadata = (
        'categories',
        'ordered',
    )
...
class TextReader(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000022B00BC4120>'
...
STR_NA_VALUES = None # (!) real value is "{'', 'N/A', '#N/A N/A', '#N/A', '#NA', 'NaN', 'nan', '-1.#QNAN', '-1.#IND', 'n/a', 'null', 'NULL', '1.#IND', '1.#QNAN', '-nan', 'NA', '-NaN', '<NA>'}"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000022B00B9C880>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.parsers', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000022B00B9C880>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\parsers.cp39-win_amd64.pyd')"
