...
class RuntimeInfo(tuple):
    """ RuntimeInfo(simd_level, detected_simd_level) """
    ...
    def _make(cls, *args, **kwargs): # real signature unknown
        """ Make a new RuntimeInfo object from a sequence or iterable """
        pass

    def _replace(self, **kwds): # reliably restored by inspect
        """ Return a new RuntimeInfo object replacing specified fields with new values """
        pass
    ...
    def __init__(self, simd_level, detected_simd_level): # real signature unknown; restored from __doc__
        pass

    @staticmethod # known case of __new__
    def __new__(_cls, simd_level, detected_simd_level): # reliably restored by inspect
        """ Create new instance of RuntimeInfo(simd_level, detected_simd_level) """
        pass
    ...
    detected_simd_level = _tuplegetter(1, 'Alias for field number 1')
    simd_level = _tuplegetter(0, 'Alias for field number 0')
    _fields = (
        'simd_level',
        'detected_simd_level',
    )
