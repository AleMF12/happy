...
class BufferedOutputStream(NativeFile):
    ...
    def detach(self): # real signature unknown; restored from __doc__
        """
        BufferedOutputStream.detach(self)
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ BufferedOutputStream.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ BufferedOutputStream.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D88CE8E750>'
