...
class FixedSizeBinaryType(DataType):
    ...
    def __reduce__(self): # real signature unknown; restored from __doc__
        """ FixedSizeBinaryType.__reduce__(self) """
        pass

    byte_width = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """
        The binary size in bytes.
        """


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D88CEBFD80>'
