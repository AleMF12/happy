...
class UnknownExtensionType(PyExtensionType):
    ...
    def __arrow_ext_serialize__(self): # real signature unknown; restored from __doc__
        """ UnknownExtensionType.__arrow_ext_serialize__(self) """
        pass

    def __init__(self, DataType_storage_type, serialized): # real signature unknown; restored from __doc__
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D88CE62120>'
