...
class _ReadStats(tuple):
    """ ReadStats(num_messages, num_record_batches, num_dictionary_batches, num_dictionary_deltas, num_replaced_dictionaries) """
    ...
    def _make(cls, *args, **kwargs): # real signature unknown
        """ Make a new ReadStats object from a sequence or iterable """
        pass

    def _replace(self, **kwds): # reliably restored by inspect
        """ Return a new ReadStats object replacing specified fields with new values """
        pass
    ...
    def __new__(_cls, num_messages, num_record_batches, num_dictionary_batches, num_dictionary_deltas, num_replaced_dictionaries): # reliably restored by inspect
        """ Create new instance of ReadStats(num_messages, num_record_batches, num_dictionary_batches, num_dictionary_deltas, num_replaced_dictionaries) """
        pass
