...
class LargeBinaryArray(Array):
    ...
    total_values_length = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D88CE530F0>'
