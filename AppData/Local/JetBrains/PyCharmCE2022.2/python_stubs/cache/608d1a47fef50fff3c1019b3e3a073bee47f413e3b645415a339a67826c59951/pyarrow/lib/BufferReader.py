...
class BufferReader(NativeFile):
    ...
    """
    def __init__(self, obj): # real signature unknown; restored from __doc__
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ BufferReader.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ BufferReader.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D88CE4B2A0>'
