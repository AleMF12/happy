...
class SignalStopHandler(object):
    # no doc
    def _init_signals(self): # real signature unknown; restored from __doc__
        """ SignalStopHandler._init_signals(self) """
        pass

    def __enter__(self): # real signature unknown; restored from __doc__
        """ SignalStopHandler.__enter__(self) """
        pass

    def __exit__(self, exc_type, exc_value, exc_tb): # real signature unknown; restored from __doc__
        """ SignalStopHandler.__exit__(self, exc_type, exc_value, exc_tb) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ SignalStopHandler.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ SignalStopHandler.__setstate_cython__(self, __pyx_state) """
        pass

    stop_token = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
