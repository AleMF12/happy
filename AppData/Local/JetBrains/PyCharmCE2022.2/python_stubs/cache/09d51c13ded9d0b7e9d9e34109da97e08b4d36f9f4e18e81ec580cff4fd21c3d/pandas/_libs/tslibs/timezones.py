...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pandas\_libs\tslibs\timezones.cp39-win_amd64.pyd
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import zoneinfo as zoneinfo # C:\Users\#Ale\.conda\envs\GCS10004\lib\zoneinfo\__init__.py
import pytz as pytz # C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pytz\__init__.py
...
class _dateutil_tzutc(__datetime.tzinfo):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.tz.tz\', \'__doc__\': "\\n    This is a tzinfo object that represents the UTC time zone.\\n\\n    **Examples:**\\n\\n    .. doctest::\\n\\n        >>> from datetime import *\\n        >>> from dateutil.tz import *\\n\\n        >>> datetime.now()\\n        datetime.datetime(2003, 9, 27, 9, 40, 1, 521290)\\n\\n        >>> datetime.now(tzutc())\\n        datetime.datetime(2003, 9, 27, 12, 40, 12, 156379, tzinfo=tzutc())\\n\\n        >>> datetime.now(tzutc()).tzname()\\n        \'UTC\'\\n\\n    .. versionchanged:: 2.7.0\\n        ``tzutc()`` is now a singleton, so the result of ``tzutc()`` will\\n        always return the same object.\\n\\n        .. doctest::\\n\\n            >>> from dateutil.tz import tzutc, UTC\\n            >>> tzutc() is tzutc()\\n            True\\n            >>> tzutc() is UTC\\n            True\\n    ", \'utcoffset\': <function tzutc.utcoffset at 0x000001A47967F310>, \'dst\': <function tzutc.dst at 0x000001A47967F3A0>, \'tzname\': <function tzutc.tzname at 0x000001A47967F430>, \'is_ambiguous\': <function tzutc.is_ambiguous at 0x000001A47967F4C0>, \'fromutc\': <function tzutc.fromutc at 0x000001A47967F5E0>, \'__eq__\': <function tzutc.__eq__ at 0x000001A47967F670>, \'__hash__\': None, \'__ne__\': <function tzutc.__ne__ at 0x000001A47967F700>, \'__repr__\': <function tzutc.__repr__ at 0x000001A47967F790>, \'__reduce__\': <method \'__reduce__\' of \'object\' objects>, \'__dict__\': <attribute \'__dict__\' of \'tzutc\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'tzutc\' objects>, \'_TzSingleton__instance\': tzutc()})'
    __hash__ = None
...
class _pytz_BaseTzInfo(__datetime.tzinfo):
    ...
    _tzname = None
    _utcoffset = None
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pytz.tzinfo', '_utcoffset': None, '_tzname': None, 'zone': None, '__str__': <function BaseTzInfo.__str__ at 0x000001A479493EE0>, '__dict__': <attribute '__dict__' of 'BaseTzInfo' objects>, '__weakref__': <attribute '__weakref__' of 'BaseTzInfo' objects>, '__doc__': None})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A479564820>'

__pyx_capi__ = {
    'get_dst_info': None, # (!) real value is '<capsule object "PyObject *(PyDateTime_TZInfo *)" at 0x000001A479564EA0>'
    'get_timezone': None, # (!) real value is '<capsule object "PyObject *(PyDateTime_TZInfo *, int __pyx_skip_dispatch)" at 0x000001A479564DE0>'
    'get_utcoffset': None, # (!) real value is '<capsule object "PyDateTime_Delta *(PyDateTime_TZInfo *, PyDateTime_DateTime *)" at 0x000001A479564E40>'
    'is_fixed_offset': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *, int __pyx_skip_dispatch)" at 0x000001A479564E70>'
    'is_tzlocal': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *)" at 0x000001A479564D20>'
    'is_utc': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *, int __pyx_skip_dispatch)" at 0x000001A479564CF0>'
    'is_zoneinfo': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *)" at 0x000001A479564D50>'
    'maybe_get_tz': None, # (!) real value is '<capsule object "PyDateTime_TZInfo *(PyObject *, int __pyx_skip_dispatch)" at 0x000001A479564E10>'
    'treat_tz_as_pytz': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *)" at 0x000001A479564D80>'
    'tz_compare': None, # (!) real value is '<capsule object "int (PyDateTime_TZInfo *, PyDateTime_TZInfo *, int __pyx_skip_dispatch)" at 0x000001A479564DB0>'
    'utc_pytz': None, # (!) real value is '<capsule object "PyDateTime_TZInfo *" at 0x000001A479564CC0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timezones', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A479564820>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\timezones.cp39-win_amd64.pyd')"

__test__ = {
    'tz_standardize (line 417)': '\n    If the passed tz is a pytz timezone object, "normalize" it to the a\n    consistent version\n\n    Parameters\n    ----------\n    tz : tzinfo\n\n    Returns\n    -------\n    tzinfo\n\n    Examples\n    --------\n    >>> from datetime import datetime\n    >>> from pytz import timezone\n    >>> tz = timezone(\'US/Pacific\').normalize(\n    ...     datetime(2014, 1, 1, tzinfo=pytz.utc)\n    ... ).tzinfo\n    >>> tz\n    <DstTzInfo \'US/Pacific\' PST-1 day, 16:00:00 STD>\n    >>> tz_standardize(tz)\n    <DstTzInfo \'US/Pacific\' LMT-1 day, 16:07:00 STD>\n\n    >>> tz = timezone(\'US/Pacific\')\n    >>> tz\n    <DstTzInfo \'US/Pacific\' LMT-1 day, 16:07:00 STD>\n    >>> tz_standardize(tz)\n    <DstTzInfo \'US/Pacific\' LMT-1 day, 16:07:00 STD>\n    ',
}
