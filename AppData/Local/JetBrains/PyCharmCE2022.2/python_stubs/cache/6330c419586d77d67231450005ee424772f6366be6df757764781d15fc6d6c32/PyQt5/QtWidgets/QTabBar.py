...
class QTabBar(QWidget):
    ...
    def isTabVisible(self, p_int): # real signature unknown; restored from __doc__
        """ isTabVisible(self, int) -> bool """
        return False
    ...
    def setTabVisible(self, p_int, bool): # real signature unknown; restored from __doc__
        """ setTabVisible(self, int, bool) """
        pass
