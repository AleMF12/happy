...
class _NullOptions(FunctionOptions):
    # no doc
    def _set_options(self, nan_is_null): # real signature unknown; restored from __doc__
        """ _NullOptions._set_options(self, nan_is_null) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _NullOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _NullOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CC30>'
