...
class _DayOfWeekOptions(FunctionOptions):
    # no doc
    def _set_options(self, count_from_zero, week_start): # real signature unknown; restored from __doc__
        """ _DayOfWeekOptions._set_options(self, count_from_zero, week_start) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _DayOfWeekOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _DayOfWeekOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CB10>'
