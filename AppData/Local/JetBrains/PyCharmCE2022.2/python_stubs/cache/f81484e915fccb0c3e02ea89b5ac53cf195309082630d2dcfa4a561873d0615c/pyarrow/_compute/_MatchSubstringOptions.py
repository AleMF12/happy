...
class _MatchSubstringOptions(FunctionOptions):
    # no doc
    def _set_options(self, pattern, ignore_case): # real signature unknown; restored from __doc__
        """ _MatchSubstringOptions._set_options(self, pattern, ignore_case) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _MatchSubstringOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _MatchSubstringOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C390>'
