...
class FunctionOptions(__pyarrow_lib._Weakrefable):
    # no doc
    def deserialize(self, buf): # real signature unknown; restored from __doc__
        """
        FunctionOptions.deserialize(buf)
    ...
    def serialize(self): # real signature unknown; restored from __doc__
        """ FunctionOptions.serialize(self) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ FunctionOptions.__reduce_cython__(self) """
        pass
    ...
    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ FunctionOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __hash__ = None
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D25C30>'
    __slots__ = ()
