...
class _RoundToMultipleOptions(FunctionOptions):
    # no doc
    def _set_options(self, multiple, round_mode): # real signature unknown; restored from __doc__
        """ _RoundToMultipleOptions._set_options(self, multiple, round_mode) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _RoundToMultipleOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _RoundToMultipleOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C2D0>'
