...
class _SetLookupOptions(FunctionOptions):
    # no doc
    def _set_options(self, value_set, bool_skip_nulls): # real signature unknown; restored from __doc__
        """ _SetLookupOptions._set_options(self, value_set, bool skip_nulls) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _SetLookupOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _SetLookupOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C9F0>'
