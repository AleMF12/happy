...
class _QuantileOptions(FunctionOptions):
    # no doc
    def _set_options(self, quantiles, interp, skip_nulls, min_count): # real signature unknown; restored from __doc__
        """ _QuantileOptions._set_options(self, quantiles, interp, skip_nulls, min_count) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _QuantileOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _QuantileOptions.__setstate_cython__(self, __pyx_state) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CF90>'
