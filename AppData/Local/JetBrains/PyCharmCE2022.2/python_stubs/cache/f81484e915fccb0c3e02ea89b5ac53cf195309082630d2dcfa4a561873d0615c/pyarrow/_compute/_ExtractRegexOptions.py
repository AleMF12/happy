...
class _ExtractRegexOptions(FunctionOptions):
    # no doc
    def _set_options(self, pattern): # real signature unknown; restored from __doc__
        """ _ExtractRegexOptions._set_options(self, pattern) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _ExtractRegexOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _ExtractRegexOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C510>'
