...
class _TDigestOptions(FunctionOptions):
    # no doc
    def _set_options(self, quantiles, delta, buffer_size, skip_nulls, min_count): # real signature unknown; restored from __doc__
        """ _TDigestOptions._set_options(self, quantiles, delta, buffer_size, skip_nulls, min_count) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _TDigestOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _TDigestOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D35030>'
