...
class _MakeStructOptions(FunctionOptions):
    # no doc
    def _set_options(self, field_names, field_nullability, field_metadata): # real signature unknown; restored from __doc__
        """ _MakeStructOptions._set_options(self, field_names, field_nullability, field_metadata) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _MakeStructOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _MakeStructOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C750>'
