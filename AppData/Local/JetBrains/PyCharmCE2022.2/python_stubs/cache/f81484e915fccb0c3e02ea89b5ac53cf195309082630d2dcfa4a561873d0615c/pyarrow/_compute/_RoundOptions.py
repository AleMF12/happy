...
class _RoundOptions(FunctionOptions):
    # no doc
    def _set_options(self, ndigits, round_mode): # real signature unknown; restored from __doc__
        """ _RoundOptions._set_options(self, ndigits, round_mode) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _RoundOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _RoundOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C210>'
