...
class ScalarFunction(Function):
    ...
    kernels = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """
        The kernels implementing this function.
        """


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D25F00>'
