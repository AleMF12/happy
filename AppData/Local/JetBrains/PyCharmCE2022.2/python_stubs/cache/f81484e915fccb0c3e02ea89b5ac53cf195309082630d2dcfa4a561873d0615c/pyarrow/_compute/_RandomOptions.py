...
class _RandomOptions(FunctionOptions):
    # no doc
    def _set_options(self, initializer): # real signature unknown; restored from __doc__
        """ _RandomOptions._set_options(self, initializer) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _RandomOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _RandomOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D350F0>'
