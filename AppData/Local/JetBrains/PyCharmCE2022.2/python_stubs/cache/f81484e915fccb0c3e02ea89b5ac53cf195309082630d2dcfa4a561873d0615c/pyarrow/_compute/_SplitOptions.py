...
class _SplitOptions(FunctionOptions):
    # no doc
    def _set_options(self, max_splits, reverse): # real signature unknown; restored from __doc__
        """ _SplitOptions._set_options(self, max_splits, reverse) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _SplitOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _SplitOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CCF0>'
