...
class _FilterOptions(FunctionOptions):
    # no doc
    def _set_options(self, null_selection_behavior): # real signature unknown; restored from __doc__
        """ _FilterOptions._set_options(self, null_selection_behavior) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _FilterOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _FilterOptions.__setstate_cython__(self, __pyx_state) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C630>'
