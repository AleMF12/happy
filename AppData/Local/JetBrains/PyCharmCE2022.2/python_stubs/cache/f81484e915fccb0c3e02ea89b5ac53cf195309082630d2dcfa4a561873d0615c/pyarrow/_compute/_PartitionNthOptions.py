...
class _PartitionNthOptions(FunctionOptions):
    # no doc
    def _set_options(self, pivot, null_placement): # real signature unknown; restored from __doc__
        """ _PartitionNthOptions._set_options(self, pivot, null_placement) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _PartitionNthOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _PartitionNthOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2CDB0>'
