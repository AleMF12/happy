...
class _PadOptions(FunctionOptions):
    # no doc
    def _set_options(self, width, padding): # real signature unknown; restored from __doc__
        """ _PadOptions._set_options(self, width, padding) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _PadOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _PadOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002BD21D2C3F0>'
