# encoding: utf-8
# module PyQt5.QtQml
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtQml.pyd
# by generator 1.147
# no doc
...
class QJSEngine(__PyQt5_QtCore.QObject):
    ...
    def setInterrupted(self, bool): # real signature unknown; restored from __doc__
        """ setInterrupted(self, bool) """
        pass

    def setUiLanguage(self, p_str): # real signature unknown; restored from __doc__
        """ setUiLanguage(self, str) """
        pass
    ...
    def uiLanguageChanged(self): # real signature unknown; restored from __doc__
        """ uiLanguageChanged(self) [signal] """
        pass
...
class QQmlApplicationEngine(QQmlEngine):
    ...
    def setInitialProperties(self, Dict, p_str=None, Any=None): # real signature unknown; restored from __doc__
        """ setInitialProperties(self, Dict[str, Any]) """
        pass
...
class QQmlComponent(__PyQt5_QtCore.QObject):
    ...
    def createWithInitialProperties(self, Dict, p_str=None, Any=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ createWithInitialProperties(self, Dict[str, Any], context: QQmlContext = None) -> QObject """
        pass
    ...
    def setInitialProperties(self, QObject, Dict, p_str=None, Any=None): # real signature unknown; restored from __doc__
        """ setInitialProperties(self, QObject, Dict[str, Any]) """
        pass
...
class QQmlEngineExtensionPlugin(__PyQt5_QtCore.QObject):
    """ QQmlEngineExtensionPlugin(parent: QObject = None) """
    def childEvent(self, *args, **kwargs): # real signature unknown
        pass
...
class QQmlListReference(__sip.simplewrapper):
    ...
    def replace(self, p_int, QObject): # real signature unknown; restored from __doc__
        """ replace(self, int, QObject) -> bool """
        return False
