...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pandas\_libs\tslibs\parsing.cp39-win_amd64.pyd
# by generator 1.147
...
class relativedelta(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.relativedelta\', \'__doc__\': "\\n    The relativedelta type is designed to be applied to an existing datetime and\\n    can replace specific components of that datetime, or represents an interval\\n    of time.\\n\\n    It is based on the specification of the excellent work done by M.-A. Lemburg\\n    in his\\n    `mx.DateTime <https://www.egenix.com/products/python/mxBase/mxDateTime/>`_ extension.\\n    However, notice that this type does *NOT* implement the same algorithm as\\n    his work. Do *NOT* expect it to behave like mx.DateTime\'s counterpart.\\n\\n    There are two different ways to build a relativedelta instance. The\\n    first one is passing it two date/datetime classes::\\n\\n        relativedelta(datetime1, datetime2)\\n\\n    The second one is passing it any number of the following keyword arguments::\\n\\n        relativedelta(arg1=x,arg2=y,arg3=z...)\\n\\n        year, month, day, hour, minute, second, microsecond:\\n            Absolute information (argument is singular); adding or subtracting a\\n            relativedelta with absolute information does not perform an arithmetic\\n            operation, but rather REPLACES the corresponding value in the\\n            original datetime with the value(s) in relativedelta.\\n\\n        years, months, weeks, days, hours, minutes, seconds, microseconds:\\n            Relative information, may be negative (argument is plural); adding\\n            or subtracting a relativedelta with relative information performs\\n            the corresponding arithmetic operation on the original datetime value\\n            with the information in the relativedelta.\\n\\n        weekday: \\n            One of the weekday instances (MO, TU, etc) available in the\\n            relativedelta module. These instances may receive a parameter N,\\n            specifying the Nth weekday, which could be positive or negative\\n            (like MO(+1) or MO(-2)). Not specifying it is the same as specifying\\n            +1. You can also use an integer, where 0=MO. This argument is always\\n            relative e.g. if the calculated date is already Monday, using MO(1)\\n            or MO(-1) won\'t change the day. To effectively make it absolute, use\\n            it in combination with the day argument (e.g. day=1, MO(1) for first\\n            Monday of the month).\\n\\n        leapdays:\\n            Will add given days to the date found, if year is a leap\\n            year, and the date found is post 28 of february.\\n\\n        yearday, nlyearday:\\n            Set the yearday or the non-leap year day (jump leap days).\\n            These are converted to day/month/leapdays information.\\n\\n    There are relative and absolute forms of the keyword\\n    arguments. The plural is relative, and the singular is\\n    absolute. For each argument in the order below, the absolute form\\n    is applied first (by setting each attribute to that value) and\\n    then the relative form (by adding the value to the attribute).\\n\\n    The order of attributes considered when this relativedelta is\\n    added to a datetime is:\\n\\n    1. Year\\n    2. Month\\n    3. Day\\n    4. Hours\\n    5. Minutes\\n    6. Seconds\\n    7. Microseconds\\n\\n    Finally, weekday is applied, using the rule described above.\\n\\n    For example\\n\\n    >>> from datetime import datetime\\n    >>> from dateutil.relativedelta import relativedelta, MO\\n    >>> dt = datetime(2018, 4, 9, 13, 37, 0)\\n    >>> delta = relativedelta(hours=25, day=1, weekday=MO(1))\\n    >>> dt + delta\\n    datetime.datetime(2018, 4, 2, 14, 37)\\n\\n    First, the day is set to 1 (the first of the month), then 25 hours\\n    are added, to get to the 2nd day and 14th hour, finally the\\n    weekday is applied, but since the 2nd is already a Monday there is\\n    no effect.\\n\\n    ", \'__init__\': <function relativedelta.__init__ at 0x0000023FD30AFF70>, \'_fix\': <function relativedelta._fix at 0x0000023FD30DC310>, \'weeks\': <property object at 0x0000023FD30D4D60>, \'_set_months\': <function relativedelta._set_months at 0x0000023FD30DC4C0>, \'normalized\': <function relativedelta.normalized at 0x0000023FD30DC550>, \'__add__\': <function relativedelta.__add__ at 0x0000023FD30DC5E0>, \'__radd__\': <function relativedelta.__radd__ at 0x0000023FD30DC670>, \'__rsub__\': <function relativedelta.__rsub__ at 0x0000023FD30DC700>, \'__sub__\': <function relativedelta.__sub__ at 0x0000023FD30DC790>, \'__abs__\': <function relativedelta.__abs__ at 0x0000023FD30DC820>, \'__neg__\': <function relativedelta.__neg__ at 0x0000023FD30DC8B0>, \'__bool__\': <function relativedelta.__bool__ at 0x0000023FD30DC940>, \'__nonzero__\': <function relativedelta.__bool__ at 0x0000023FD30DC940>, \'__mul__\': <function relativedelta.__mul__ at 0x0000023FD30DC9D0>, \'__rmul__\': <function relativedelta.__mul__ at 0x0000023FD30DC9D0>, \'__eq__\': <function relativedelta.__eq__ at 0x0000023FD30DCA60>, \'__hash__\': <function relativedelta.__hash__ at 0x0000023FD30DCAF0>, \'__ne__\': <function relativedelta.__ne__ at 0x0000023FD30DCB80>, \'__div__\': <function relativedelta.__div__ at 0x0000023FD30DCC10>, \'__truediv__\': <function relativedelta.__div__ at 0x0000023FD30DCC10>, \'__repr__\': <function relativedelta.__repr__ at 0x0000023FD30DCCA0>, \'__dict__\': <attribute \'__dict__\' of \'relativedelta\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'relativedelta\' objects>})'
...
class tzoffset(__datetime.tzinfo):
    ...
    _cache_lock = None # (!) real value is '<unlocked _thread.lock object at 0x0000023FD2774BA0>'
    _TzOffsetFactory__instances = None # (!) real value is '<WeakValueDictionary at 0x23fd2774e50>'
    _TzOffsetFactory__strong_cache = OrderedDict()
    _TzOffsetFactory__strong_cache_size = 8
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'dateutil.tz.tz', '__doc__': '\\n    A simple class for representing a fixed offset from UTC.\\n\\n    :param name:\\n        The timezone name, to be returned when ``tzname()`` is called.\\n    :param offset:\\n        The time zone offset in seconds, or (since version 2.6.0, represented\\n        as a :py:class:`datetime.timedelta` object).\\n    ', '__init__': <function tzoffset.__init__ at 0x0000023FD27CA8B0>, 'utcoffset': <function tzoffset.utcoffset at 0x0000023FD27CA940>, 'dst': <function tzoffset.dst at 0x0000023FD27CA9D0>, 'tzname': <function tzoffset.tzname at 0x0000023FD27CAA60>, 'fromutc': <function tzoffset.fromutc at 0x0000023FD27CAB80>, 'is_ambiguous': <function tzoffset.is_ambiguous at 0x0000023FD27CAC10>, '__eq__': <function tzoffset.__eq__ at 0x0000023FD27CACA0>, '__hash__': None, '__ne__': <function tzoffset.__ne__ at 0x0000023FD27CAD30>, '__repr__': <function tzoffset.__repr__ at 0x0000023FD27CADC0>, '__reduce__': <method '__reduce__' of 'object' objects>, '__dict__': <attribute '__dict__' of 'tzoffset' objects>, '__weakref__': <attribute '__weakref__' of 'tzoffset' objects>, '_TzOffsetFactory__instances': <WeakValueDictionary at 0x23fd2774e50>, '_TzOffsetFactory__strong_cache': OrderedDict(), '_TzOffsetFactory__strong_cache_size': 8, '_cache_lock': <unlocked _thread.lock object at 0x0000023FD2774BA0>})"
    __hash__ = None
...
class _dateutil_tzstr(__dateutil_tz_tz.tzrange):
    ...
    _TzStrFactory__cache_lock = None # (!) real value is '<unlocked _thread.lock object at 0x0000023FD276FF30>'
    _TzStrFactory__instances = None # (!) real value is '<WeakValueDictionary at 0x23fd276ffd0>'
...
class _dateutil_tzutc(__datetime.tzinfo):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.tz.tz\', \'__doc__\': "\\n    This is a tzinfo object that represents the UTC time zone.\\n\\n    **Examples:**\\n\\n    .. doctest::\\n\\n        >>> from datetime import *\\n        >>> from dateutil.tz import *\\n\\n        >>> datetime.now()\\n        datetime.datetime(2003, 9, 27, 9, 40, 1, 521290)\\n\\n        >>> datetime.now(tzutc())\\n        datetime.datetime(2003, 9, 27, 12, 40, 12, 156379, tzinfo=tzutc())\\n\\n        >>> datetime.now(tzutc()).tzname()\\n        \'UTC\'\\n\\n    .. versionchanged:: 2.7.0\\n        ``tzutc()`` is now a singleton, so the result of ``tzutc()`` will\\n        always return the same object.\\n\\n        .. doctest::\\n\\n            >>> from dateutil.tz import tzutc, UTC\\n            >>> tzutc() is tzutc()\\n            True\\n            >>> tzutc() is UTC\\n            True\\n    ", \'utcoffset\': <function tzutc.utcoffset at 0x0000023FD27CA3A0>, \'dst\': <function tzutc.dst at 0x0000023FD27CA430>, \'tzname\': <function tzutc.tzname at 0x0000023FD27CA4C0>, \'is_ambiguous\': <function tzutc.is_ambiguous at 0x0000023FD27CA550>, \'fromutc\': <function tzutc.fromutc at 0x0000023FD27CA670>, \'__eq__\': <function tzutc.__eq__ at 0x0000023FD27CA700>, \'__hash__\': None, \'__ne__\': <function tzutc.__ne__ at 0x0000023FD27CA790>, \'__repr__\': <function tzutc.__repr__ at 0x0000023FD27CA820>, \'__reduce__\': <method \'__reduce__\' of \'object\' objects>, \'__dict__\': <attribute \'__dict__\' of \'tzutc\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'tzutc\' objects>, \'_TzSingleton__instance\': tzutc()})'
    __hash__ = None
...
class _timelex(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas._libs.tslibs.parsing', '__init__': <cyfunction _timelex.__init__ at 0x0000023FD30DF1E0>, 'get_tokens': <cyfunction _timelex.get_tokens at 0x0000023FD30DF380>, 'split': <classmethod object at 0x0000023FD30D99A0>, '__dict__': <attribute '__dict__' of '_timelex' objects>, '__weakref__': <attribute '__weakref__' of '_timelex' objects>, '__doc__': None})"


# variables with complex values

DEFAULTPARSER = None # (!) real value is '<dateutil.parser._parser.parser object at 0x0000023FD30F61C0>'

_DEFAULT_DATETIME = None # (!) real value is 'datetime.datetime(1, 1, 1, 0, 0)'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000023FD2763FA0>'

__pyx_capi__ = {
    'get_rule_month': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000023FD276F660>'
    'quarter_to_myear': None, # (!) real value is '<capsule object "PyObject *(int, int, PyObject *, int __pyx_skip_dispatch)" at 0x0000023FD276F630>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.parsing', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000023FD2763FA0>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\parsing.cp39-win_amd64.pyd')"

__test__ = {
    'concat_date_cols (line 1121)': "\n    Concatenates elements from numpy arrays in `date_cols` into strings.\n\n    Parameters\n    ----------\n    date_cols : tuple[ndarray]\n    keep_trivial_numbers : bool, default True\n        if True and len(date_cols) == 1, then\n        conversion (to string from integer/float zero) is not performed\n\n    Returns\n    -------\n    arr_of_rows : ndarray[object]\n\n    Examples\n    --------\n    >>> dates=np.array(['3/31/2019', '4/31/2019'], dtype=object)\n    >>> times=np.array(['11:20', '10:45'], dtype=object)\n    >>> result = concat_date_cols((dates, times))\n    >>> result\n    array(['3/31/2019 11:20', '4/31/2019 10:45'], dtype=object)\n    ",
    'get_rule_month (line 1197)': "\n    Return starting month of given freq, default is December.\n\n    Parameters\n    ----------\n    source : str\n        Derived from `freq.rule_code` or `freq.freqstr`.\n\n    Returns\n    -------\n    rule_month: str\n\n    Examples\n    --------\n    >>> get_rule_month('D')\n    'DEC'\n\n    >>> get_rule_month('A-JAN')\n    'JAN'\n    ",
}
