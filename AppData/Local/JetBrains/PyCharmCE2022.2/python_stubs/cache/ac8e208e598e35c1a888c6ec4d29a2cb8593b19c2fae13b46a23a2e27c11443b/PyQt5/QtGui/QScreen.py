...
class QScreen(__PyQt5_QtCore.QObject):
    ...
    def grabWindow(self, PyQt5_sip_voidptr, x=0, y=0, width=-1, height=-1): # real signature unknown; restored from __doc__
        """ grabWindow(self, PyQt5.sip.voidptr, x: int = 0, y: int = 0, width: int = -1, height: int = -1) -> QPixmap """
        return QPixmap
    ...
    def virtualSiblingAt(self, QPoint): # real signature unknown; restored from __doc__
        """ virtualSiblingAt(self, QPoint) -> QScreen """
        return QScreen
