...
class QPaintEngine(__sip.simplewrapper):
    ...
    def drawLines(self, PyQt5_sip_array, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def drawPoints(self, PyQt5_sip_array, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def drawPolygon(self, PyQt5_sip_array, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        drawPolygon(self, PyQt5.sip.array[Union[QPointF, QPoint]], QPaintEngine.PolygonDrawMode)
        drawPolygon(self, PyQt5.sip.array[QPoint], QPaintEngine.PolygonDrawMode)
        """
        pass

    def drawRects(self, PyQt5_sip_array, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
