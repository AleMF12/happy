...
class QOpenGLBuffer(__sip.simplewrapper):
    ...
    def allocate(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        allocate(self, PyQt5.sip.voidptr, int)
        allocate(self, int)
        """
        pass
    ...
    def map(self, QOpenGLBuffer_Access): # real signature unknown; restored from __doc__
        """ map(self, QOpenGLBuffer.Access) -> PyQt5.sip.voidptr """
        pass
    ...
    def mapRange(self, p_int, p_int_1, Union, QOpenGLBuffer_RangeAccessFlags=None, QOpenGLBuffer_RangeAccessFlag=None): # real signature unknown; restored from __doc__
        """ mapRange(self, int, int, Union[QOpenGLBuffer.RangeAccessFlags, QOpenGLBuffer.RangeAccessFlag]) -> PyQt5.sip.voidptr """
        pass

    def read(self, p_int, PyQt5_sip_voidptr, p_int_1): # real signature unknown; restored from __doc__
        """ read(self, int, PyQt5.sip.voidptr, int) -> bool """
        return False
    ...
    def write(self, p_int, PyQt5_sip_voidptr, p_int_1): # real signature unknown; restored from __doc__
        """ write(self, int, PyQt5.sip.voidptr, int) """
        pass
