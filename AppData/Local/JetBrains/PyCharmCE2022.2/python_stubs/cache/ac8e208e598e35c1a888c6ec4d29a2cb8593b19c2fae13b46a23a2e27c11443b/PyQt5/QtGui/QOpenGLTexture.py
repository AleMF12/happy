...
class QOpenGLTexture(__sip.simplewrapper):
    ...
    def setCompressedData(self, p_int, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setCompressedData(self, int, int, QOpenGLTexture.CubeMapFace, int, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setCompressedData(self, int, int, int, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setCompressedData(self, int, int, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setCompressedData(self, int, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setCompressedData(self, int, int, int, QOpenGLTexture.CubeMapFace, int, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        """
        pass

    def setData(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setData(self, int, int, QOpenGLTexture.CubeMapFace, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setData(self, int, int, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setData(self, int, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setData(self, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setData(self, QImage, genMipMaps: QOpenGLTexture.MipMapGeneration = QOpenGLTexture.GenerateMipMaps)
        setData(self, int, int, int, QOpenGLTexture.CubeMapFace, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setData(self, int, int, int, int, int, int, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setData(self, int, int, int, int, int, int, int, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setData(self, int, int, int, int, int, int, int, int, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setData(self, int, int, int, int, int, int, int, int, QOpenGLTexture.CubeMapFace, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        setData(self, int, int, int, int, int, int, int, int, QOpenGLTexture.CubeMapFace, int, QOpenGLTexture.PixelFormat, QOpenGLTexture.PixelType, PyQt5.sip.voidptr, options: QOpenGLPixelTransferOptions = None)
        """
        pass
