...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtWebKitWidgets.pyd
# by generator 1.147
# no doc
...
class QWebFrame(__PyQt5_QtCore.QObject):
    ...
    def childFrames(self): # real signature unknown; restored from __doc__
        """ childFrames(self) -> List[QWebFrame] """
        return []
    ...
    def metaData(self): # real signature unknown; restored from __doc__
        """ metaData(self) -> Dict[str, List[str]] """
        return {}
...
class QWebHitTestResult(__sip.simplewrapper):
    """
    QWebHitTestResult()
