...
class QGeoRouteRequest(__sip.simplewrapper):
    ...
    def setDepartureTime(self, Union, QDateTime=None, datetime_datetime=None): # real signature unknown; restored from __doc__
        """ setDepartureTime(self, Union[QDateTime, datetime.datetime]) """
        pass
