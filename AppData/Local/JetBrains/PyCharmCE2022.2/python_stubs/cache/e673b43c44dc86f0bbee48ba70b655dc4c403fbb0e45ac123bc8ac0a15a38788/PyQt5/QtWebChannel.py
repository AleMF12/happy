...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtWebChannel.pyd
# by generator 1.147
# no doc
...
class QWebChannelAbstractTransport(__PyQt5_QtCore.QObject):
    ...
    def messageReceived(self, Dict, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ messageReceived(self, Dict[str, Union[QJsonValue, QJsonValue.Type, Iterable[QJsonValue], bool, int, float, None, str]], QWebChannelAbstractTransport) [signal] """
        pass
    ...
    def sendMessage(self, Dict, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ sendMessage(self, Dict[str, Union[QJsonValue, QJsonValue.Type, Iterable[QJsonValue], bool, int, float, None, str]]) """
        pass
