...
class ActionType(__importlib__bootstrap._ActionType):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pyarrow._flight', '__doc__': 'A type of action that is executable on a Flight service.', 'make_action': <cyfunction ActionType.make_action at 0x000002D403EB0D40>, '__dict__': <attribute '__dict__' of 'ActionType' objects>})"
