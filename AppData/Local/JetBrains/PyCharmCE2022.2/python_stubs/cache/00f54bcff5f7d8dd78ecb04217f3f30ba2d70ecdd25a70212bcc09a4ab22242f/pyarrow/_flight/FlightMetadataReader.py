...
class FlightMetadataReader(__pyarrow_lib._Weakrefable):
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ FlightMetadataReader.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ FlightMetadataReader.__setstate_cython__(self, __pyx_state) """
        pass
