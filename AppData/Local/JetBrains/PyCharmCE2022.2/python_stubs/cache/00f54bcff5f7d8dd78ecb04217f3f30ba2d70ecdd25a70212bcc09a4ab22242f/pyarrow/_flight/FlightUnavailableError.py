...
class FlightUnavailableError(FlightError, __pyarrow_lib.ArrowException):
    ...
    def __reduce_cython__(self): # real signature unknown; restored from __doc__
        """ FlightUnavailableError.__reduce_cython__(self) """
        pass

    def __setstate_cython__(self, __pyx_state): # real signature unknown; restored from __doc__
        """ FlightUnavailableError.__setstate_cython__(self, __pyx_state) """
        pass

    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x00007FFF94B3F350>, '__reduce_cython__': <method '__reduce_cython__' of 'pyarrow._flight.FlightUnavailableError' objects>, '__setstate_cython__': <method '__setstate_cython__' of 'pyarrow._flight.FlightUnavailableError' objects>, '__dict__': <attribute '__dict__' of 'pyarrow._flight.FlightUnavailableError' objects>, '__doc__': 'The server is not reachable or available.', '__pyx_vtable__': <capsule object NULL at 0x000002D41257E930>})"
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D41257E930>'
