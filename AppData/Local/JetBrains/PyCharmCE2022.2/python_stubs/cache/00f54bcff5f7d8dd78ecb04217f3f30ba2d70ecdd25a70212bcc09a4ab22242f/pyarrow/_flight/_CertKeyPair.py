...
class _CertKeyPair(tuple):
    ...
    def _make(cls, *args, **kwargs): # real signature unknown
        """ Make a new _CertKeyPair object from a sequence or iterable """
        pass

    def _replace(self, **kwds): # reliably restored by inspect
        """ Return a new _CertKeyPair object replacing specified fields with new values """
        pass
    ...
    def __init__(self, cert, key): # real signature unknown; restored from __doc__
        pass

    @staticmethod # known case of __new__
    def __new__(_cls, cert, key): # reliably restored by inspect
        """ Create new instance of _CertKeyPair(cert, key) """
        pass
    ...
    cert = _tuplegetter(0, 'Alias for field number 0')
    key = _tuplegetter(1, 'Alias for field number 1')
    _fields = (
        'cert',
        'key',
    )
