...
class FlightTimedOutError(FlightError, __pyarrow_lib.ArrowException):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x00007FFF94B3E160>, '__reduce_cython__': <method '__reduce_cython__' of 'pyarrow._flight.FlightTimedOutError' objects>, '__setstate_cython__': <method '__setstate_cython__' of 'pyarrow._flight.FlightTimedOutError' objects>, '__dict__': <attribute '__dict__' of 'pyarrow._flight.FlightTimedOutError' objects>, '__doc__': 'The Flight RPC call timed out.', '__pyx_vtable__': <capsule object NULL at 0x000002D412573E10>})"
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D412573E10>'
