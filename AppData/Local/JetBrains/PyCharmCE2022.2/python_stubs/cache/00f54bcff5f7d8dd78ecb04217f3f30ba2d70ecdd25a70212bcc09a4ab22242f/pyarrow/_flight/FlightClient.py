...
class FlightClient(__pyarrow_lib._Weakrefable):
    ...
    def do_put(self, FlightDescriptor_descriptor, Schema_schema, FlightCallOptions_options=None): # real signature unknown; restored from __doc__
        """
        FlightClient.do_put(self, FlightDescriptor descriptor: FlightDescriptor, Schema schema: Schema, FlightCallOptions options: FlightCallOptions = None)
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D412573480>'
