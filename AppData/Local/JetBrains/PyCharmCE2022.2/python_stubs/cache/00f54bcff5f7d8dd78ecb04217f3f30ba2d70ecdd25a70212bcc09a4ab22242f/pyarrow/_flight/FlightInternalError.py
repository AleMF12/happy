...
class FlightInternalError(FlightError, __pyarrow_lib.ArrowException):
    ...
    def __reduce_cython__(self): # real signature unknown; restored from __doc__
        """ FlightInternalError.__reduce_cython__(self) """
        pass

    def __setstate_cython__(self, __pyx_state): # real signature unknown; restored from __doc__
        """ FlightInternalError.__setstate_cython__(self, __pyx_state) """
        pass

    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x00007FFF94B3DEE0>, '__reduce_cython__': <method '__reduce_cython__' of 'pyarrow._flight.FlightInternalError' objects>, '__setstate_cython__': <method '__setstate_cython__' of 'pyarrow._flight.FlightInternalError' objects>, '__dict__': <attribute '__dict__' of 'pyarrow._flight.FlightInternalError' objects>, '__doc__': 'An error internal to the Flight server occurred.', '__pyx_vtable__': <capsule object NULL at 0x000002D412573C60>})"
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002D412573C60>'
