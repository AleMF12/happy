...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\pyarrow\_hdfsio.cp39-win_amd64.pyd
# by generator 1.147
# no doc
...
class HadoopFileSystem(__pyarrow_lib._Weakrefable):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002A1F1364F00>'
...
class HdfsFile(__pyarrow_lib.NativeFile):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002A1F1364EA0>'
...
class Queue(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'queue', '__doc__': 'Create a queue object with a given maximum size.\\n\\n    If maxsize is <= 0, the queue size is infinite.\\n    ', '__init__': <function Queue.__init__ at 0x000002A1FF8A08B0>, 'task_done': <function Queue.task_done at 0x000002A1FF8A0940>, 'join': <function Queue.join at 0x000002A1FF8A09D0>, 'qsize': <function Queue.qsize at 0x000002A1FF8A0A60>, 'empty': <function Queue.empty at 0x000002A1FF8A0AF0>, 'full': <function Queue.full at 0x000002A1FF8A0B80>, 'put': <function Queue.put at 0x000002A1FF8A0C10>, 'get': <function Queue.get at 0x000002A1FF8A0CA0>, 'put_nowait': <function Queue.put_nowait at 0x000002A1FF8A0D30>, 'get_nowait': <function Queue.get_nowait at 0x000002A1FF8A0DC0>, '_init': <function Queue._init at 0x000002A1FF8A0E50>, '_qsize': <function Queue._qsize at 0x000002A1FF8A0EE0>, '_put': <function Queue._put at 0x000002A1FF8A0F70>, '_get': <function Queue._get at 0x000002A1FF8AF040>, '__class_getitem__': <classmethod object at 0x000002A1FF8A6EB0>, '__dict__': <attribute '__dict__' of 'Queue' objects>, '__weakref__': <attribute '__weakref__' of 'Queue' objects>})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002A1F1364D30>'

__spec__ = None # (!) real value is "ModuleSpec(name='pyarrow._hdfsio', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002A1F1364D30>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pyarrow\\\\_hdfsio.cp39-win_amd64.pyd')"
