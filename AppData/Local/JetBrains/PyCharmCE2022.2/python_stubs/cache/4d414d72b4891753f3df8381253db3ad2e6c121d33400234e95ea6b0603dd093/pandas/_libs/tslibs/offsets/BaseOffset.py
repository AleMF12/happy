...
class BaseOffset(object):
    ...
    freqstr = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x000001E5CFB8C400>'
    _adjust_dst = True
    _attributes = (
        'n',
        'normalize',
    ...
    _params = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x000001E5CFB81EC0>'
