...
_relativedelta_kwds = None # (!) real value is "{'minute', 'nanoseconds', 'millisecond', 'microsecond', 'seconds', 'hour', 'years', 'hours', 'minutes', 'months', 'nanosecond', 'year', 'weeks', 'milliseconds', 'days', 'day', 'weekday', 'month', 'microseconds', 'second'}"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001E5CF2682B0>'

__pyx_capi__ = {
    'is_offset_object': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x000001E5CF2686C0>'
    'is_tick_object': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x000001E5CF2686F0>'
    'to_offset': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x000001E5CF268690>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.offsets', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001E5CF2682B0>, origin='C:\\\\Users\\\\#Ale\\\\.conda\\\\envs\\\\GCS10004\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\offsets.cp39-win_amd64.pyd')"
