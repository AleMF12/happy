...
# from C:\Users\#Ale\.conda\envs\GCS10004\lib\site-packages\PyQt5\QtWebKit.pyd
# by generator 1.147
# no doc
...
class QWebDatabase(__sip.simplewrapper):
...
class QWebElement(__sip.simplewrapper):
    """
    QWebElement()
...
class QWebElementCollection(__sip.simplewrapper):
    """
...
class QWebHistory(__sip.simplewrapper):
    # no doc
    ...
    def items(self): # real signature unknown; restored from __doc__
        """ items(self) -> List[QWebHistoryItem] """
        return []
...
class QWebHistoryItem(__sip.simplewrapper):
...
class QWebPluginFactory(__PyQt5_QtCore.QObject):
    ...
    def plugins(self): # real signature unknown; restored from __doc__
        """ plugins(self) -> List[QWebPluginFactory.Plugin] """
        return []
...
class QWebSecurityOrigin(__sip.simplewrapper):
    """
    ...
    def allOrigins(self): # real signature unknown; restored from __doc__
        """ allOrigins() -> List[QWebSecurityOrigin] """
        return []
    ...
    def databases(self): # real signature unknown; restored from __doc__
        """ databases(self) -> List[QWebDatabase] """
        return []
...
class QWebSettings(__sip.simplewrapper):
    # no doc
