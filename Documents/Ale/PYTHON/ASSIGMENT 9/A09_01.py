...
I created 2 different dictionaries one a dictionary named as full2abbrev that translates 
the name of the Bible book to  3-letter abbreviation.
After that I created the second dictionary called abbrev2full that translates the 3-letter
abbreviation back to the corresponding full book name.
The  file bible-fullname.txt is updated make sure that the order of the Bible books is
maintained.
Also I removed a iregularity in the first file of abbreviatting showed called as next'Ahh'
I updated the second file with a reference using the real bible structure. Based on the code above.
Finally I overwrite the information from the bible to the text file. And displayed the books of bible on the screen.
The full names of the abbreviation  and abbreviations of the full name.
