#  tests for colorama-0.4.5-py39haa95532_0 (this is a generated file);
print('===== testing package: colorama-0.4.5-py39haa95532_0 =====');
...
print(Style.DIM + 'dim, '
    ...
    + Style.NORMAL + 'normal'
    , end=' ')
print()#  --- run_test.py (end) ---

print('===== colorama-0.4.5-py39haa95532_0 OK =====');
